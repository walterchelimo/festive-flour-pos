...
$SN=mysqli_num_rows($SS);
if($SN>0){
    while($r=mysqli_fetch_array($SS)){
        $newbales1=$r['BalePackets'];
        $new_1KGBales1=$r['1kgPackets'];
        $new_2KGBales1=$r['2kgPackets'];
    }
}

$S1="SELECT * FROM packetpurchase WHERE PPurchaseId='$id'";
$SS1=mysqli_query($conn,$S1);
$SN1=mysqli_num_rows($SS1);
if($SN1>0){
    while($r1=mysqli_fetch_array($SS1)){

        $ProductName1=$r1['ProductName'];
        $Supplier1=$r1['SupplierName'];
        $Location1=$r1['Location'];
        $Bales1=$r1['Bales'];
        $_1KGPackets1=$r1['1KGPackets'];
        $_2KGPackets1=$r1['2KGPackets'];
        $BaleCost1=$r1['BaleCost'];
        $_1KGPacketCost1=$r1['1KGPacketCost'];
        $_2KGPacketCost1=$r1['2KGPacketCost'];
        $Payment1=$r1['Payment'];
        $TotalDue1=$r1['TotalDue'];
    }
}
...
$newbales=($newbales1-$Bales1)+$Bales;
$new_1KGBales=($new_1KGBales1-$_1KGPackets1)+$_1KGPackets;
$new_2KGBales=($new_2KGBales1-$_2KGPackets1)+$_2KGPackets;

$sql = "UPDATE packetpurchase SET ProductName='$ProductName',SupplierName='$Supplier',Location='$Location',Bales='$Bales',1KGPackets='$_1KGPackets',2KGPackets='$_2KGPackets',BaleCost='$BaleCost',1KGPacketCost='$_1KGPacketCost',2KGPacketCost='$_2KGPacketCost',Payment='$Payment',TotalDue='$TotalDue' WHERE PPurchaseId='$id'";
$que=mysqli_query($conn,$sql);
if($que){
    ?>
    <script>
    alert('Packets Edited Successfull');
    window.history.back();
...
<label>Product Name:<caps>*</caps></label>
      ...
      <option value="<?php echo $ProductName1; ?>  "><?php echo $ProductName1; ?> </option>
           <?php
           include "connect.php";
    ...
    <div class="col-lg-4 col-sm-12">    
      ...
      <select name="SupplierName" id="category" class="form-control">
      <option value="<?php echo $Supplier1; ?>  "><?php echo $Supplier1 ?> </option>
           <?php
           include "connect.php";
...
<label>Location:<caps>*</caps> </label>
      ...
      <option value="<?php echo $Location1; ?>  "><?php echo $Location1 ?> </option>
           <?php
           include "connect.php";
            $sql = mysqli_query($conn,"SELECT * FROM suppliers ORDER BY SupplierName DESC ");                                                                                   
            while($row = mysqli_fetch_array($sql) ){
...
?>
  ...
  <div class="card">
    ...
    <h2>&nbsp;&nbsp;Quantity</h2>    
     <div class="col-lg-4 col-sm-12">   
        <label>Bale Packets<caps>*</caps></label>
      <input type="number" class="form-control" value="<?php echo $Bales1 ?>" name="Bales" onkeyup="calculate(this.value)">
    </div>
    <div class="col-lg-4 col-sm-12">    
        <label>1 KG Packets<caps>*</caps></label>
      <input type="number" class="form-control" value="<?php echo $_1KGPackets1 ?>" name="1KGPackets" onkeyup="calculate(this.value)">
    </div>
    <div class="col-lg-4 col-sm-12">    
        <label>2 KG Packets<caps>*</caps></label>
      <input type="number" class="form-control" value="<?php echo $_2KGPackets1 ?>" name="2KGPackets" onkeyup="calculate(this.value)">
    </div>
    </div>
    <div class="row">
    <h2>&nbsp;&nbsp;Cost</h2>       
     <div class="col-lg-4 col-sm-12">    
        <label>Bale Packet Cost<caps>*</caps></label>
      <input type="number" step=0.01 class="form-control" value="<?php echo $BaleCost1 ?>" name="BaleCost" onkeyup="calculate(this.value)">
    </div>
    <div class="col-lg-4 col-sm-12">    
        <label>1 KG Packet Cost<caps>*</caps></label>
      <input type="number" step=0.01 class="form-control" value="<?php echo $_1KGPacketCost1 ?>" name="1KGPacketCost" onkeyup="calculate(this.value)">
    </div>

    <div class="col-lg-4 col-sm-12">    
        <label>2 KG Packet Cost<caps>*</caps></label>
      <input type="number" step=0.01 class="form-control" value="<?php echo $_2KGPacketCost1 ?>" name="2KGPacketCost" onkeyup="calculate(this.value)">
    </div>
    </div></div>
    <div class="card">
      <div class="row">
    <div class="col-lg-4 col-sm-12">    
        <label>Payment Amount <caps>*</caps></label>
      <input type="number" step=0.01 class="form-control" value="<?php echo $Payment1 ?>" name="Payment" onkeyup="calculate(this.value)">
    </div>
    <div class="col-lg-4 col-sm-12"> </div>
    <div class="col-lg-4 col-sm-12">    
        <label>Total Due<caps>*</caps></label>
      <input type="number" step=0.01 class="form-control" value="<?php echo $TotalDue1 ?>" name="TotalDue" >
    </div></div><br>
    </div>
    <input type="submit" class="btn btn-info"  name="purchase" id="submit" value="Purchase Packets">
</form>
<script type="text/javascript">
    function calculate() {
      ...
      if (isNaN(document.forms["myform"]["1KGPackets"].value) || document.forms["myform"]["1KGPackets"].value == "") {
        var text3 = 0;
      } else {
        var text3 = parseInt(document.forms["myform"]["1KGPackets"].value);
      }
      if (isNaN(document.forms["myform"]["2KGPackets"].value) || document.forms["myform"]["2KGPackets"].value == "") {
        var text2 = 0;
      } else {
        var text2 = parseInt(document.forms["myform"]["2KGPackets"].value);
      }
      if (isNaN(document.forms["myform"]["BaleCost"].value) || document.forms["myform"]["BaleCost"].value == "") {
        var text5 = 0;
      } else {
        var text5 = parseInt(document.forms["myform"]["BaleCost"].value);
      }
      if (isNaN(document.forms["myform"]["1KGPacketCost"].value) || document.forms["myform"]["1KGPacketCost"].value == "") {
        var text7 = 0;
      } else {
        var text7 = parseFloat(document.forms["myform"]["1KGPacketCost"].value);
      }
      if (isNaN(document.forms["myform"]["2KGPacketCost"].value) || document.forms["myform"]["2KGPacketCost"].value == "") {
        var text8 = 0;
      } else {
        var text8 = parseFloat(document.forms["myform"]["2KGPacketCost"].value);
      }
      if (isNaN(document.forms["myform"]["Payment"].value) || document.forms["myform"]["Payment"].value == "") {
        var text9 = 0;
      } else {
        var text9 = parseFloat(document.forms["myform"]["Payment"].value);
      }
      document.forms["myform"]["TotalDue"].value = (text1 * text5)+(text3*text7)+(text2*text8)-text9;
    }
  </script>
