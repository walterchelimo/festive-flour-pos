      ...
      <div class="card-body">
        <div class="row">
          ...
          if (isset($_POST['submit'])) {
            $range1 = $_POST['Range1'];
            $range2 = $_POST['Range2'];
            $sql = "SELECT * FROM customerorder WHERE Date BETWEEN '$range1' AND '$range2' ORDER BY ID DESC";
          ...
          ?><div class="col-lg-2 col-sm-8">
              ...
              <div id="Print"><?php
                              ...
                              echo "<th>Terms Of Recurrence</th>";
            ...
            $sql = "SELECT * FROM expenses ORDER BY expense_ID";
            $results21 = mysqli_query($conn, $sql);
            $num_rows21 = mysqli_num_rows($results21);
            if ($num_rows21 > 0) {
              ?><div class="col-lg-2 col-sm-8">
              ...
              <script>
                ...
                updateSubTotal1(); // Initial call
                    function updateSubTotal1() {
                      ...
                      document.getElementById("val1").innerHTML = "Total Expense is = KES " + subTotal.toFixed(0);
                    }
