...
<hr style="border-top: 3px double #8c8b8b;">
    ...
    $sql="SELECT * FROM customers WHERE Date BETWEEN '$range1' AND '$range2' ORDER BY CustomerId DESC";
  ...
  $sql101="SELECT * FROM customers ORDER BY CustomerId DESC";
...
<script>
      ...
      function updateSubTotal1() {
        ...
        document.getElementById("val1").innerHTML = "  Total number of customers is " + x;}
 </script>
<script>
