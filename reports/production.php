      ...
      <div class="card">
        <div class="card-body">
          <div class="row">
            ...
            <form method="POST" action="">
              <div class="row">
                <div class="col-md-2">
                  ...
                  <input type="date" class="form-control" id="range1" name="Range1">
                </div>
                <div class="col-md-2">
                  <label for="Range">To</label>
                  <input type="date" class="form-control" id="range2" name="Range2">
                </div>
                  <div class="col-md-2">
                  <label for="Range"></label>
                  <input id="submit"  class="form-control bg-primary text-light mt-2" type="submit" value="search" name="submit">
                  </div>
                </div>
                <div class="col_21"><br>
                </div>
            ...
            if (isset($_POST['submit'])) {
              ...
              $sql = "SELECT * FROM endproduction WHERE Date BETWEEN '$range1' AND '$range2' ORDER BY Eid DESC";
            ...
            ?>
                <div class="row">
                  ...
                  <div class="col">
                    <i class="bi bi-printer-fill" onclick="printDiv()" style="font-size:35px;color:black;float:right;"></i>
                  </div>
                </div>
                <div id="Print">
                  <?php
                  ...
                  echo "<th>Production ID</th>";
                  echo "<th>Raw Material Name</th>";
                  echo "<th>Product</th>";
                  echo "<th>Raw Materials Utilized</th>";
                  echo "<th>Products Produced</th>";
                  echo "<th>1KG Products</th>";
                  echo "<th>1KG Packaging Rate</th>";
                  echo "<th>2KG Products</th>";
                  echo "<th>2KG Packaging Rate</th>";
                  echo "<th>Total Wages</th>";
                  ...
                  while ($row = mysqli_fetch_array($results21)) {
                    ...
                    echo "<td>" . $row['1KGBales'] . "</td>";
                    echo "<td>" . $row['1KGRate'] . "</td>";
                    echo "<td>" . $row['2KGBales'] . "</td>";
                    echo "<td>" . $row['2KGRate'] . "</td>";
                    echo "<td>" . $row['DailyWage'] . "</td>";
                    echo "<td>" . $row['Date'] . "</td>";
                  ...
                  ?>
              <div class="row">
              </div><br></table><div id="val1"></div><div id="val2"></div><div id="val3"></div><div id="val4"></div><div id="val5"></div>
              <?php
              } elseif ($num_rows21 < 1) {
                echo "No records found";
              }
            } else {
              $sql11 = "SELECT * FROM endproduction ORDER BY Eid DESC";
              $results21 = mysqli_query($conn, $sql11);
              $num_rows21 = mysqli_num_rows($results21);
              if ($num_rows21 > 0) {
            ?>
                <div class="row">
        ...
        <script>
          ...
          function updateSubTotal1() {
            ...
            document.getElementById("val1").innerHTML = "          Total Sacks: " + subTotal;
          }
          ...
          function updateSubTotal2() {
            ...
            document.getElementById("val2").innerHTML = "     Total products: " + subTotal;
          }
          ...
          function updateSubTotal3() {
            ...
            document.getElementById("val3").innerHTML = "         Total 1kg Bales are: " + subTotal;
          }
          ...
          function updateSubTotal4() {
            ...
            document.getElementById("val4").innerHTML = "        Total 2kg Bale are: " + subTotal;
          }
          updateSubTotal5(); // Initial call
          function updateSubTotal5() {
            var table = document.getElementById("dtVerticalScrollExample");
            let subTotal = Array.from(table.rows).slice(1).reduce((total, row) => {
              return total + parseFloat(row.cells[9].innerHTML);
            }, 0);
            document.getElementById("val5").innerHTML = "        Total Wages are: " + subTotal.toFixed(2);
          }
        </script>
        <script>
