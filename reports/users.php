...
<hr style="border-top: 3px double #8c8b8b;">
    ...
    $sql="SELECT * FROM addusers WHERE Date BETWEEN '$range1' AND '$range2' ORDER BY user_ID DESC";
  ...
  <?php
      ...
      <table class="table  table-striped table-bordered table-hover"  border="1"  id="dtVerticalScrollExample">
      <?php
     ...
     while($row=mysqli_fetch_array($results21)){
        echo "<tbody id='myTable'>";
         ...
         echo "<td>".$row['LastName']." ".$row['LastName']."</td>" ;
               ...
               ?> <div id="val1"></div></div><?php

               echo "</tr>";
 }}elseif($num_rows21<1){
    echo "No records found";
 }}else {
    $sql101="SELECT * FROM addusers  ORDER BY user_ID DESC";
...
<script>
      ...
      function updateSubTotal1() {
        var x = document.getElementById("dtVerticalScrollExample").rows.length-1;
        document.getElementById("val1").innerHTML = "  Total number of users is " + x;}
 </script>
</main>
    </body>
