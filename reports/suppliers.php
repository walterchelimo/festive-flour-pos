...
<hr style="border-top: 3px double #8c8b8b;">
  ...
  <?php 
    ...
    $sql="SELECT * FROM suppliers WHERE Date BETWEEN '$range1' AND '$range2' ORDER BY SupplierId DESC";
...
<div id="Print">
  ...
  $sql101="SELECT * FROM suppliers  ORDER BY SupplierId DESC";
