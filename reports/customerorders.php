...
<a class="nav-link collapsed" href="../logout.php">
  ...
  <main id="main" class="main">
    <span>Reports </span> Customer Orders
    <div class="card">
      <div class="card-body">
        <div class="row">
          ...
          if (isset($_POST['submit'])) {
            $range1 = $_POST['Range1'];
            $range2 = $_POST['Range2'];
            $sql = "SELECT * FROM customerorder WHERE OrderDate BETWEEN '$range1' AND '$range2' ORDER BY OrderId DESC";
          ...
          ?><div class="col-lg-2 col-sm-8">
            ...
            $sql = "SELECT * FROM customerorder ORDER BY OrderId DESC";
            $results21 = mysqli_query($conn, $sql);
            $num_rows21 = mysqli_num_rows($results21);
            if ($num_rows21 > 0) {
              ?><div class="col-lg-2 col-sm-8">
              ...
              <script>
                ...
                updateSubTotal1(); // Initial call
                    function updateSubTotal1() {
                      ...
                      document.getElementById("val1").innerHTML = "Total 1kg Order= " + subTotal.toFixed(0);
                    }
                    ...
                    function updateSubTotal2() {
                      ...
                      document.getElementById("val2").innerHTML = "Total 2kg Order = " + subTotal.toFixed(0);
                    }
              </script>
