...
<a class="nav-link collapsed" href="../logout.php">
  ...
  <main id="main" class="main">
    ...
    $sql = "SELECT * FROM attendance WHERE Date BETWEEN '$range1' AND '$range2' ORDER BY AttendanceId DESC";
    ...
    if ($num_rows21>0) {?>
     ...
     ?>
              <div class="row">
              </div><br></table><div id="val1"></div><div id="val2"></div>
              <?php
            } elseif ($num_rows21<1) {
              echo "No records found";
            }
          } else {
            $sql33 = "SELECT * FROM attendance ";
    ...
    <script>
      ...
      function updateSubTotal2() {
        ...
        document.getElementById("val2").innerHTML = "     Total Wages = KES "   + subTotal.toFixed(2);
      }
    </script>
    <script>
