...
<main id="main" class="main">
     <span>Reports </span> Sales  
  <div>
    <div class="card">
  <div class="card-body">
      <div class="row">
      <i class="bi bi-funnel"></i><h4>Filter</h4>
      <?php
  include "../connect.php";
  ?>
...
<?php 
    ...
    $sql="SELECT * FROM sales WHERE SellDate BETWEEN '$range1' AND '$range2' ORDER BY Sellid DESC";
...
<div class="col-lg-2 col-sm-8">
 ...
 </div><br></table><br><div id="val1" style="font: size 1px;"></div><div id="val2"></div><div id="val3"></div>
 <?php
    }elseif($num_rows21<1){
        echo "No records found";
    }}else{
        $sql101="SELECT * FROM sales ORDER BY Sellid DESC";
        $results201=mysqli_query($conn,$sql101);
        $num_rows201=mysqli_num_rows($results201);
        if($num_rows201>0){
            ?>
        <div class="col-lg-2 col-sm-8">
  <input class="form-control" id="myInput" type="text" placeholder="Search...">
  ...
  <div id="Print">
        <?php
            echo "<div class='table-responsive' style='height:500px;'>";
               ...
               echo "<th>Payment Status</th>";
               echo "</tr>";
          while($row=mysqli_fetch_array($results201)){
              $cusname=$row['CustomerName'];
              echo "<tbody id='myTable'>";
                   echo "<tr>";
                   ?>
    ...
    <script>
      ...
      function updateSubTotal1() {
        ...
        document.getElementById("val1").innerHTML = "                      Total Amount of Sales= KES  " + subTotal.toFixed(2);
      }
      ...
      function updateSubTotal2() {
        ...
        document.getElementById("val2").innerHTML = "        Total Paid Sales = KES  "   + subTotal.toFixed(2);
      }
      ...
      function updateSubTotal3() {
        ...
        document.getElementById("val3").innerHTML = "         Due Sales = KES  " + subTotal.toFixed(2);
      }
    </script>
    <script>
