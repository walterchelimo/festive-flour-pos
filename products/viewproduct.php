...
<div class="container">
  <form action="" method="POST">
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="ProductName" value="<?php echo $pname; ?>" name="ProductName" readonly>
    </div>
    <div class="form-group">
      <label for="CategoryUnit">1KG Available:</label>
      <input type="text" class="form-control" id="CategoryUnit" value="<?php echo $_1kgAvailable; ?>" name="1kgAvailable" readonly>
    </div>
    <div class="form-group">
      <label for="Availability">2KG Available:</label>
      <input type="text" class="form-control" id="Availability" value="<?php echo $_2kgAvailable; ?>" name="2kgAvailable" readonly>
    </div>
    <a href="products.php" class="btn btn-danger col-md-3">Back</a>
  </form>
</div>
