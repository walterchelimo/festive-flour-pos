...
$CategoryUnit=$_POST['CategoryUnit'];
$Availability=$_POST['Availability'];

$sql="INSERT INTO products (ProductName, CategoryUnit, Availability) VALUES ('$ProductName','$CategoryUnit','$Availability')";
...
<div class="card">
  ...
  <div class="form-group">
    ...
    <label for="CategoryUnit"> Category Unit:</label>
      <input type="text" class="form-control" id="CategoryUnit" name="CategoryUnit">
    </div>
    <div class="col-md-4">
    ...
    <div class="row"><input class="btn btn-primary" type="submit" value="Submit" name="submit"></div>
  </div>
</div>
</div>
