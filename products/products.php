...
<main id="main" class="main">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="col">
                ...
                <div class="col">
                <?php
                if(strpos($permission,'apro')!== false){
                ?>
      ...
      <div class="modal-content p-3">
        ...
        <div class="modal-body">
          ...
          if(isset($_POST['submit'])){
            ...
            $onebaq=$_POST['1baq'];
            $twobaq=$_POST['2baq'];
          $sql="INSERT INTO products (ProductName,1baq,2baq) VALUES('$ProductName','$onebaq','$twobaq')";
  ...
  <div class="row mb-3">
    ...
    <div class="col">
        Alert Quantity(1KG Bales)
      <input type="number"step="any" class="form-control" id="1baq" name="1baq">
    </div>
    <div class="col">
        Alert Quantity(2KG Bales)
      <input type="number" step="any" class="form-control" id="2baq" name="2baq">
    </div>
        </div>
...
<?php 
    ...
    if($num_rows21>0){
        echo "<div class='table-responsive' style='height:500px;'>";
           ...
           echo "<th>Actions</th>";
           echo "<th>Product</th>";
           echo "<th>Available IKG Bales</th>";
           echo "<th>Available 2KG Bales</th>";
               ...
               ?>
                <td>
                    <div class="dropdown">
                      ...
                      <?php
                      if(strpos($permission,'dpro')!== false){
                      ?>
                        <a class="dropdown-item" href="delete.php?id=<?php echo $row['ID']; ?>"><i class="bi bi-trash"></i>Delete</a>
                        <?php
                        }
                        ?>

                        <?php
                        if(strpos($permission,'vpro')!== false){
                        ?>
    ...
    <?php
               ...
               echo "<td>".$row['1kgAvailable']."</td>";
               echo "<td>".$row['2kgAvailable']."</td>";
