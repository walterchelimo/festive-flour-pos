...
if (isset($_POST["submit"]) and !empty($_POST["id"])){
    ...
    if ($result){
        ...
        echo "<a class='btn btn-primary col-md-4' href='expenses.php'>BACK</a>";
        echo "</div>";
    }else{
...
<div class="row m-2">
    <div class="alert alert-danger">
        <form action="deleteexpenses.php" method="post">
            ...
            <div class="p-2 text-center">
                ...
                <a href="expenses.php" class="btn btn-primary col-md-3">NO</a>
            </div>
        </form>
