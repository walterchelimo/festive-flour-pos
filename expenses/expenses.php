    ...
    include "../connect.php";
                ...
                if(isset($_POST['submit'])){
                    $ExpenseCategory=$_POST['ExpenseCategory'];
                        ...
                        $termsAccepted=$_POST['terms_of_reccurence'];
                    
                    $sql="INSERT INTO expenses (ExpenseCategory,ExpenseName,TotalAmount,terms_of_reccurence) VALUES ('$ExpenseCategory','$ExpenseName','$TotalAmount','$termsAccepted')";
...
<div class="row">
        ...
        <label>Expense Category:<caps>*</caps> <i class="bi bi-info-circle-fill text-primary" ></i></label>
        <select name="ExpenseCategory" id="category" class="form-control">
                                                    <?php
                                          include "../connect.php";
                                        $sql = mysqli_query($conn,"SELECT * FROM expensecategpory ORDER BY expensecategory_ID DESC ");
        ...
        <div class="col-lg-4 col-sm-12">
        <label>Expense Name:<caps>*</caps></label>
      ...
      <input type="checkbox" name="terms_of_reccurence" style="height:25px; width:25px;">
                            </div>
                                                <div class="col col-lg-9">
                    <label>Is reccurent?</label>
                            </div>
    </div>
                    </div>
 ...
 Show  <select name="entries" id="entries">
  ...
  <input class="form-control" id="myInput" type="text" placeholder="Search...">
      ...
      <div class="row py-4">
          <?php 
    include "../connect.php";
    $sql="SELECT * FROM expenses ORDER BY expense_ID  DESC LIMIT 10 ";
    ...
    if($num_rows21>0){ 
          echo "<div class='table-responsive'>";
           ...
           echo "<th>Terms Of Reccurence</th>";
           echo "<th>Action</th>";
           echo "</tr>";
     ...
     while($row=mysqli_fetch_array($results21)){
      echo "<tbody id='myTable'>";
         ...
         echo "<td>".$row['ExpenseName']."</td>" ;
               ...
               echo "<td>".$row['terms_of_reccurence']."</td>" ;
               echo " <td>
                   
                    <a class='m-2 text-light' href='delete.php?id=".$row['expense_ID']."'><span class='bi bi-trash p-2 bg-danger' style='font-size:20px; border-radius:4px;' >Delete</span></a>
                    <a class='m-2' href='view.php?id=".$row['expense_ID']."'><span class='bi bi-pencil-square bg-primary p-2'  style='font-size:20px; border-radius:4px;'>Edit</span> </a>
                   </td>";
