...
<a class="nav-link collapsed" href="../logout.php">
  ...
  <form action="" method="POST">
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="ExpenseName" value="<?php echo $ename; ?>" name="ExpenseName">
    </div>
    <div class="form-group">
      <label for="Amount">Amount:</label>
      <input type="text" class="form-control" id="Amount" value="<?php echo $amount; ?>" name="Amount">
    </div>
    <div class="form-group">
    ...
    <a href="expenses.php" class="btn btn-danger col-md-3">Back</a>
  </form>
</div>
