...
<a class="nav-link collapsed" href="../logout.php">
  ...
  <script src="assets/js/main.js"></script>
    ...
    include "../connect.php";
                if(isset($_POST['submit'])){
                    ...
                    $sql="insert into expensecategpory (ExpenseCategory,CategoryCode) values('$ExpenseCategory','$CategoryCode')";
  ...
  <main id="main" class="main">
           <span>Expense Category </span> manage your expense Categories
  ...
  <div class="card-body">
      <div class="row">
          <div class="col">
              <span>All your expense categories</span>
          </div>
        <div class="col">
  <button type="button" class="btn btn-info btn-lg" id="btn1" data-toggle="modal" data-target="#myModal"><i class="bi bi-plus-circle"></i>Add</button>
 ...
 Show  <select name="entries" id="entries">
  ...
  <input class="form-control" id="myInput" type="text" placeholder="Search...">
      ...
      <div class="row">
          <?php 
    include "../connect.php";
    $sql="SELECT * FROM expensecategpory ORDER BY expensecategory_ID DESC";
     ...
     while($row=mysqli_fetch_array($results21)){
         ...
         echo "<td>".$row['CategoryCode']."</td>" ;
               echo " <td>
                    ...
                    <a class='m-2 text-light' href='delete.php?id=".$row['expensecategory_ID']."'><span class='bi bi-trash p-2 bg-danger' style='font-size:20px; border-radius:4px;' >Delete</span></a>
                    <a class='m-2' href='view.php?id=".$row['expensecategory_ID']."'><span class='bi bi-pencil-square bg-primary p-2'  style='font-size:20px; border-radius:4px;'>Edit</span> </a>
                    </td>";
