...
<a class="nav-link collapsed" href="../logout.php">
  ...
  <div class="container">
  <h2>Update Selling Price Details</h2>
  <form action="" method="POST">
    <div class="form-group">
      <label for="First Name">Buying Price of Raw Material:</label>
      <input type="text" class="form-control" id="BuyingPriceOfRawMaterials" value="<?php echo $BP; ?>" name="BuyingPriceOfRawMaterials">
    </div>
    <div class="form-group">
      <label for="pwd">Number Of Sacks:</label>
      <input type="text" class="form-control" id="NumberOfSacks" value="<?php echo $NumberOfSacks; ?>" name="NumberOfSacks">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      <label for="QualityPercentage">Quality Percentage:</label>
      <input type="text" class="form-control" id="QualityPercentage" value="<?php echo $QualityPercentage; ?>" name="QualityPercentage">
    </div>
    <div class="form-group">
      <label for="PacketPrice">Packet Price</label>
      <input type="text" class="form-control" id="PacketPrice" value="<?php echo $PacketPrice; ?>" name="PacketPrice">
    </div>
    <div class="form-group">
      <label for="BalePacketPrice">Bale Packet Price:</label>
      <input type="text" class="form-control" id="BalePacketPrice" value="<?php echo $BalePacketPrice; ?>" name="BalePacketPrice">
    </div>
    <div class="form-group">
      <label for="NumberOfBales">Number Of Bales:</label>
      <input type="text" class="form-control" id="NumberOfBales" value="<?php echo $NumberOfBales; ?>" name="NumberOfBales">
    </div>
    <div class="form-group">
      <label for="NumberOfLabourers">Number Of Labourers:</label>
      <input type="text" class="form-control" id="NumberOfLabourers" value="<?php echo $NumberOfLabourers; ?>" name="NumberOfLabourers">
    </div>
    <div class="form-group">
      <label for="TransportExpense">TransportExpense:</label>
      <input type="text" class="form-control" id="TransportExpense" value="<?php echo $TransportExpense; ?>" name="TransportExpense">
    </div>
    <div class="form-group">
      <label for="TotalMonthlyExpense">TotalMonthlyExpense:</label>
      <input type="text" class="form-control" id="TotalMonthlyExpense" value="<?php echo $TotalMonthlyExpense; ?>" name="TotalMonthlyExpense">
    </div>
    <div class="form-group">
      <label for="NumberOfBalesToBeTransported">NumberOfBalesToBeTransported:</label>
      <input type="text" class="form-control" id="NumberOfBalesToBeTransported" value="<?php echo $NumberOfBalesToBeTransported; ?>" name="NumberOfBalesToBeTransported">
    </div>
    <div class="form-group">
      <label for="BranCost">BranCost:</label>
      <input type="text" class="form-control" id="BranCost" value="<?php echo $BranCost; ?>" name="BranCost">
    </div>
    <button type="submit" name="update" class="btn btn-primary">Update Changes</button>
    <a href="dailyproduction.php" class="btn btn-danger col-md-3">Back</a>
  </form>
</div>
