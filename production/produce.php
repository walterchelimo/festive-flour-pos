...
<div class="row" style="padding-bottom: 10px;">
    ...
    <div class="col-lg-4 col-sm-12">
        ...
        <div>
        <input type="number" min=1 name="WorkingDays" class="form-control" placeholder="eg. 26" onkeyup="calculate(this.value)">
        </div>
    </div>
    <div class="col-lg-4 col-sm-12">
        <label>Number Of Labours</label>
        <div>
        <input type="number" min=1 name="NumberOfLabour" class="form-control" placeholder="eg. 3" onkeyup="calculate(this.value)">
        </div>
    </div>
    <div class="col-lg-4 col-sm-12">
        <label>Total Labour Cost</label>
        <div>
        <input type="number" step="0.01" min=1 name="TotalLabourCost" class="form-control">
        </div>
    </div>
</div>
...
<div class="col-lg-4 col-sm-12">
        ...
        <div>
        <input type="number" min=1 step="0.01" name="TotalAddedValues" class="form-control" value="<?php echo $_SESSION['Taddvalues']; ?>">
        </div>
    </div>
    <div class="col-lg-4 col-sm-12">
        <div>
        <input type="number" step="any" hidden min=1 name="TotalMonthlyExpenses" class="form-control" value="<?php echo $_SESSION['Tsalaries']; ?>">
        </div>
    </div>
        ...
        <div class="card">
            ...
            <div class="col-lg-4 col-sm-12">
                    ...
                    <div>
                    <input type="number" min=1 step="0.01" name="RecycleCost" class="form-control" onkeyup="calculate2(this.value)">
                    </div>
                </div>
                <div class="col-lg-4 col-sm-12">
                    <label>weight</label>
                    <div>
                    <input type="number" min=1 step="0.01" name="weight" class="form-control" onkeyup="calculate2(this.value)">
                    </div>
                </div>
                <div class="col-lg-4 col-sm-12">
                    <label>Recycled Percentage %</label>
                    <div>
                    <input type="number" min=1 step="0.01" name="percentage" class="form-control" onkeyup="calculate2(this.value)" value="<?php echo $_SESSION['wastedpercentage'] ?>">
                    </div>
                </div>
                <div class="col-lg-4 col-sm-12">
                    <label>Total Recycled Cost</label>
                    <div>
                    <input type="number" min=1 step="0.01" name="TotalRecycledCost" class="form-control">
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-sm-12">
                    ...
                    <div>
                    <input type="number" min=1 step="0.01" name="WeightPerSack" class="form-control" placeholder="eg. 90" required onkeyup="calculate3(this.value)">
                    </div>
                </div>
                <div class="col-lg-4 col-sm-12">
                    <label>Product Packaging Unit (Weight)</label>
                    <div>
                    <input type="number" min=1 step="0.01" name="WeightPerBale" class="form-control" placeholder="eg. 24" required onkeyup="calculate3(this.value)">
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-sm-12">
                    ...
                    <div>
                    <input type="number" min=1 step="any" name="BalePrice" class="form-control" required>
                    </div>
                </div>
                     ...
                     <div class="row">
               <input type="submit" class="form-control" name="submit" id="save" value="Produce">
      </div>
