...
<div class="row" style="padding-bottom: 10px;">
    <div class="col-lg-4 col-sm-12">
        ...
        <div>
        <input type="number" min=1 name="WorkingDays" class="form-control" placeholder="eg. 26">
        </div>
    </div>
    <div class="col-lg-4 col-sm-12">
        <label>Number Of Labours</label>
        <div>
        <input type="number" min=1 name="NumberOfLabour" class="form-control" placeholder="eg. 3">
        </div>
    </div>
    <div class="col-lg-4 col-sm-12">
        <label>Total Labour Cost</label>
        <div>
        <input type="number" min=1 name="TotalLabourCost" class="form-control">
        </div>
    </div>
</div>
...
<div class="col-lg-4 col-sm-12">
        ...
        <div>
        <input type="number" min=1 name="TotalAddedValues" class="form-control">
        </div>
    </div>
    <div class="col-lg-4 col-sm-12">
        <label>Total Monthly Expenses</label>
        <div>
        <input type="number" min=1 name="TotalMonthlyExpenses" class="form-control">
        </div>
    </div>
        ...
        <div class="card">
            ...
            <div class="col-lg-4 col-sm-12">
                    ...
                    <div>
                    <input type="number" min=1 name="RecycleCost" class="form-control">
                    </div>
                </div>
                <div class="col-lg-4 col-sm-12">
                    <label>weight</label>
                ...
                <div class="col-lg-4 col-sm-12">
                    <label>Wasted Percentage</label>
                    <div>
                    <input type="number" min=1 name="percentage" class="form-control">
                    </div>
                </div>
                <div class="col-lg-4 col-sm-12">
                    <label>Total Recycled Cost</label>
                    <div>
                    <input type="number" min=1 name="TotalRecycledCost" class="form-control">
                    </div>
                </div>
