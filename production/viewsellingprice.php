...
<?php
    include "../connect.php";
    $id=$_GET['id'];
    $sql="SELECT * FROM sellingproduction WHERE sp_ID='$id'";
...
if($numres>0){
    while($row=mysqli_fetch_array($res)){
        ...
        $RecycledCost=$row['RecycleCost'];
        $weight=$row['weight'];
        $percentage=$row['percentage'];
        $TotalRecycleCost=$row['TotalRecycledCost'];
          ...
          <div class="card">
              <div class="card-body">
                  ...
                  <div class="row">
                      <div class="col">
                          <div>
                          <label>Working Days:</label> <?php echo $WorkingDays ?>
                              </div>
                          <div>
                          <label>Number Of Labours:</label> <?php echo $NumberOfLabour ?>
                              </div>
                          <div>
                          <label>Labour Cost:</label> <?php echo $TotalLabourCost ?>
                          </div>
                          <div>
                          <label>Total Added Values:</label> <?php echo $TotalAddedValues ?>
                          </div>
                          <div>
                          <label>Recycle Cost:</label> <?php echo $RecycledCost ?>
                          </div>
                      </div>
                          ...
                          <label>Weight:</label> <?php echo $weight ?>
                                                ...
                                                <div>
                          <label>Recycled Percentage:</label>  <?php echo $percentage ?> %
                                                </div>
                                                <div>
                          <label>Total Recycled Cost:</label> <?php echo $TotalRecycleCost ?>
                                                </div>
                                                <div>
                          <label>Weight Per Sack:</label> <?php echo $WeightPerSack ?>
                                                </div>
                                                <div>
                          <label>Weight Per Bale:</label> <?php echo $WeightPerBale ?>
                                                </div>
                      </div>
                  </div><hr>
                  <div class="row">
                      <div class="col">
                  <label>Bale Price:</label> <?php echo $BalePrice ?>
                          </div>
                                            <div class="col">
                  <label>Selling Price:</label> <?php echo $tota ?>
                          </div>
                      </div>
                 <hr>
              </div>
