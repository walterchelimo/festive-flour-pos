...
if (isset($_POST["submit"]) and !empty($_POST["id"])){
    ...
    $sql = "DELETE FROM `sellingproduction` WHERE sp_ID=$id";
    ...
    if ($result){
        ...
        echo "<a class='btn btn-primary col-md-4' href='dailyproduction.php'>BACK</a>";
        echo "</div>";
...
<div class="row m-2">
    <div class="alert alert-danger">
        <form action="deleteselling.php" method="post">
            ...
            <div class="p-2 text-center">
                ...
                <a href="dailyproduction.php" class="btn btn-primary col-md-3">NO</a>
