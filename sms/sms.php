...
<li>
  ...
  <br>
    <?php 
    include "../connect.php";
    $sql="SELECT * FROM addusers ORDER BY id DESC LIMIT 10 ";
    $results21=mysqli_query($conn, $sql);
    $num_rows21=mysqli_num_rows($results21);
    if($num_rows21>0){ 
            echo " <h3>Select A Customer To message</h3>";
     ...
     while($row=mysqli_fetch_array($results21)){
         ...
         echo "<td>".$row['LastName']."</td>" ;
               ...
               <a class='m-2' href='../compose.php?id=".$row['ID']."'><span class='bi bi-chat-dots-fill' style='color:#3595f6'></span></a>
                    </td>";
