...
<main id="main" class="main">
  ...
  <h2>Add New Packet Purchase</h2>

  <form action="insertpackets.php" method="POST" name="myform">
    <div class="card">
    <div class="row">
    ...
    <div class="card">
      ...
      <h2>&nbsp;&nbsp;Quantity</h2>    
       <div class="col-lg-4 col-sm-12">   
        ...
        <input type="number" class="form-control" name="Bales" value="0" onkeyup="calculate(this.value)">
      </div>
      <div class="col-lg-4 col-sm-12">    
          <label>1 KG Packets<caps>*</caps></label>
        <input type="number" class="form-control" name="1KGPackets" value="0" onkeyup="calculate(this.value)">
      </div>
      <div class="col-lg-4 col-sm-12">    
          <label>2 KG Packets<caps>*</caps></label>
        <input type="number" class="form-control" name="2KGPackets" value="0" onkeyup="calculate(this.value)">
      </div>
      </div>
      <div class="row">
      <h2>&nbsp;&nbsp;Cost</h2>       
       <div class="col-lg-4 col-sm-12">    
        ...
        <input type="number" step=0.01 class="form-control" name="BaleCost" required onkeyup="calculate(this.value)">
      </div>
      <div class="col-lg-4 col-sm-12">    
          <label>1 KG Packet Cost<caps>*</caps></label>
        <input type="number" step=0.01 class="form-control" name="1KGPacketCost" required onkeyup="calculate(this.value)">
      </div>
      <div class="col-lg-4 col-sm-12">    
          <label>2 KG Packet Cost<caps>*</caps></label>
        <input type="number" step=0.01 class="form-control" name="2KGPacketCost" required onkeyup="calculate(this.value)">
      </div>
      </div></div>
      <div class="card">
        <div class="row">
      <div class="col-lg-4 col-sm-12">    
        ...
        <input type="number" step=0.01 class="form-control" name="Payment"  onkeyup="calculate(this.value)">
      </div>
      <div class="col-lg-4 col-sm-12"> </div>
      <div class="col-lg-4 col-sm-12">    
          <label>Total Due<caps>*</caps></label>
        <input type="number" step=0.01 class="form-control" name="TotalDue" >
      </div></div><br>
      </div>
