...
<a class="nav-link collapsed" href="../logout.php">
  ...
  <main id="main" class="main">
    <span>Payment Account </span>Sales.
    <div class="card">
        <div class="card-body">
                <div class="row">
            <div class="col">
...
<?php 
    include "../connect.php";
    $log7="Select SUM(Due), SUM(PaymentAmount) FROM sales WHERE PaymentMethod='Cash'";
    $res7=mysqli_query($conn,$log7);
    if($res7){
        while($row=mysqli_fetch_array($res7)){
            $TotalDue=$row['SUM(Due)'];
...
$log9="Select SUM(Due), SUM(PaymentAmount) FROM sales WHERE PaymentMethod='Mpesa'";
...
$log10="Select SUM(Due), SUM(PaymentAmount) FROM sales WHERE PaymentMethod='BankTransfer'";
...
$log11="Select SUM(Due), SUM(PaymentAmount) FROM sales WHERE PaymentMethod='Cheque'";
