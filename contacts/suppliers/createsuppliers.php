...
<form action="addsuppliers.php" method="POST">
    ...
    <div class="row">
      <div class="col-lg-4 col-sm-12">
          <label>Supplier ID:<caps>*</caps><i class="bi bi-info-circle-fill text-primary"></i></label>
          <input type="text" class="form-control" name="SupplierId" required placeholder="Supplier ID">
    </div>
    <div class="col-lg-4 col-sm-12">
          <label>Supplier Name:<caps>*</caps></label>
          <input type="text" class="form-control" name="SupplierName" required placeholder="Supplier Name">
    </div>
    <div class="col-lg-4 col-sm-12">
          <label>Location:<caps>*</caps><i class="bi bi-info-circle-fill text-primary"></i></label>
      ...
      <div class="col-lg-4 col-sm-12">    
        ...
        <input type="Date" class="form-control" name="Date" >
            ...
            <div class="col-lg-4 col-sm-12">    
          <label>Email:<caps>*</caps></label>
        <input type="email"  class="form-control" name="Email"  required placeholder="Example... joseph@gmail.com">
      </div>        
            <div class="col-lg-4 col-sm-12">    
          <label>Phone Number:<caps>*</caps></label>
