...
<a class="nav-link collapsed" href="../../logout.php">
  ...
  <main id="main" class="main">
     ...
     <span>Suppliers </span> manage suppliers
...
<span>All Suppliers</span>
            ...
            <div class="col">
            <?php
            if(strpos($permission,'asup')!== false){
            ?>
            <a href="createsuppliers.php"><button type="button" class="btn btn-info btn-lg" style="float:right;"><i class="bi bi-plus-circle"></i>Add</button></a>
            </div>
            <?php
            }
            ?>
 ...
 Show  <select name="entries" id="entries">
  ...
  <input class="form-control" id="myInput" type="text" placeholder="Search...">
      ...
      <div class="row">
          <?php 
    include "../../connect.php";
    $sql="SELECT * FROM suppliers ORDER BY SupplierName DESC LIMIT 10 ";
    ...
    if($num_rows21>0){ 
     ...
     while($row=mysqli_fetch_array($results21)){
               ...
               if(strpos($permission,'asup') !== false){
                ?>
                <td>
                <a class='m-2 text-light' href='deletesuppliers.php?id=<?php echo $row['SupplierId'] ?>'><span class='bi bi-trash p-2 bg-danger' style='font-size:20px; border-radius:4px;' >Delete</span></a>
                
                <?php
               }if(strpos($permission,'Esup') !== false){
                ?>
                <a class='m-2' href='viewsuppliers.php?id=<?php echo $row['SupplierId'] ?>'><span class='bi bi-pencil-square bg-primary p-2'  style='font-size:20px; border-radius:4px;'>Edit</span> </a>

                <?php
               }if(strpos($permission,'vsup') !== false){
                ?>
                <a class='m-2' href='viewprofile.php?id=<?php echo $row['SupplierId'] ?>'><span class='bi bi-eye bg-info p-2 text-light'  style='font-size:20px; border-radius:4px;'>view </span></a>
                </td>
                <?php
               }
