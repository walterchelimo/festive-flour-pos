...
?>
  ...
  <form action="" method="POST">
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="SupplierName" value="<?php echo $SupplierName; ?>" name="SupplierName">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      <label for="PhoneNumber">Added On:</label>
      <input type="date" class="form-control" id="PhoneNumber" value="<?php echo $AddedOn; ?>" name="AddedOn">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="Address" value="<?php echo $PhoneNumber; ?>" name="PhoneNumber">
    </div>
    <input type="submit" name="update" class="btn btn-primary" value="Update Changes">
  </form>
          </div>
          </div>
