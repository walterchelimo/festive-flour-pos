  ...
  <form action="addcustomers.php" method="POST">
    ...
    <div class="row">
      <div class="col-lg-4 col-sm-12">
          <label>Customer ID:<caps>*</caps><i class="bi bi-info-circle-fill text-primary"></i></label>
          <input type="text" class="form-control" name="CustomerId" required placeholder="Customer ID">
    </div>

    <div class="col-lg-4 col-sm-12">
          <label>Customer Name:<caps>*</caps></label>
      ...
      <div class="col-lg-4 col-sm-12">
          ...
          <input type="email" class="form-control" name="Email" required placeholder="Email Address">
            ...
            <div class="col-lg-4 col-sm-12">    
          <label>Phone Number:<caps>*</caps><i class="bi bi-info-circle-fill text-primary"></i></label>
