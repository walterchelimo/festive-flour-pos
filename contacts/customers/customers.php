...
<span>All Customers</span>
            ...
            <div class="col">
              <?php
            if(strpos($permission,'acus') !== false){
                ?>
                <a href="createcustomers.php"><button type="button" class="btn btn-info btn-lg" style="float:right;"><i class="bi bi-plus-circle"></i>Add</button></a>
                </td>
                <?php
               }
  ...
  <input class="form-control" id="myInput" type="text" placeholder="Search...">
    ...
    if($num_rows21>0){ 
     ...
     while($row=mysqli_fetch_array($results21)){
               ...
               if(strpos($permission,'acus') !== false){
                ?>
                <a class='m-1 d-inline-flex text-light' href='deletecustomers.php?id=<?php echo $row['CustomerId'] ?>'><span class='bi bi-trash p-1 bg-danger' style='font-size:20px; border-radius:4px;' ></span></a>
                
                <?php
               }if(strpos($permission,'Ecus') !== false){
                ?>
                <a class='m-1 d-inline-flex' href='updatecustomers.php?id=<?php echo $row['CustomerId'] ?>'><span class='bi bi-pencil-square bg-primary p-1'  style='font-size:20px; border-radius:4px;'></span> </a>

                <?php
               }if(strpos($permission,'vcus') !== false){
                ?>
                <a class='m-1 d-inline-flex' href='viewcustomers.php?id=<?php echo $row['CustomerId'] ?>'><span class='bi bi-eye bg-info p-1 text-light'  style='font-size:20px; border-radius:4px;'> </span></a>
