...
if (isset($_POST["submit"]) and !empty($_POST["id"])){
    ...
    if ($result){
        ...
        $insert	= "INSERT INTO logs (FirstName,Role) VALUES('$username','deleted a customer')";
        ...
        echo "<a class='btn btn-primary col-md-4' href='customers.php'>BACK</a>";
        echo "</div>";
    ...
    <div class="alert alert-danger">
        <form action="" method="post">
            ...
            <div class="p-2 text-center">
                ...
                <a href="customers.php" class="btn btn-primary col-md-3">NO</a>
            </div>
        </form>
