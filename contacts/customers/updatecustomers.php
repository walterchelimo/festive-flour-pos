...
if(isset($_POST['update'])){
    $CustomerName1=$_POST['CustomerName'];
    $Date1=$_POST['Date'];
    $Location1=$_POST['Location'];
    $Email1=$_POST['Email'];
    $PhoneNumber1=$_POST['PhoneNumber'];

   $sql1="UPDATE customers SET CustomerName='$CustomerName1', Date='$Date1', Location='$Location1', Email='$Email1',PhoneNumber='$PhoneNumber1'
    WHERE CustomerId='$ID'";
...
<a class="nav-link collapsed" href="../../logout.php">
  ...
  <form action="" method="POST">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="CustomerName" value="<?php echo $CustomerName; ?>" name="CustomerName">
    </div>
    <div class="form-group">
      <label for="pwd">Added On:</label>
      <input type="date" class="form-control" id="Date" value="<?php echo $Date; ?>" name="Date">
    </div>
    <div class="form-group">
      <label for="email">Location</label>
      <input type="tel" class="form-control" id="Location" value="<?php echo $Location; ?>" name="Location">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="PhoneNumber" value="<?php echo $PhoneNumber; ?>" name="PhoneNumber">
    </div>
