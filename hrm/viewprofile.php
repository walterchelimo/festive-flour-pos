...
<a class="nav-link collapsed" href="../logout.php">
  ...
  <main id="main" class="main">
      <div class="row">
          <div class="col">
      <span>View Casual Labourer </span>
              </div>
          </div>
    ...
    include "../connect.php";
                $id=$_GET['id'];
    $sql22="SELECT * FROM casuals WHERE Casualid='$id'";
                $res22=mysqli_query($conn,$sql22);
                $num22=mysqli_num_rows($res22);
                if($num22>0){
                    while($row1=mysqli_fetch_array($res22)){
...
<div class="card">
  <div class="card-body" id="cardb">
        <div class="row" style="text-align:center;" >
            <span style="border-radius:50%;height:100px;margin-left:auto;margin-right:auto; border:4px solid #525f7f; text-align:center; font-size:46px; width:100px; background-color:gray; color:black;"><?php echo strtoupper(substr($fname, 0, 2))  ?></span>
      ...
      <hr>
          ...
          <div class="col">
             <span style="color:blue;"><?php echo $pnumber ?></span> 
          </div>
      </div>
      <hr>
                  <div class="row">
      ...
      <a href="viewcasual.php?id=<?php echo $_GET['id'];  ?>"><input type="button" class="bg-primary col-12" value="EDIT"></a>
      </div>
...
<div class="col-lg-9 col-sm-12">
 <div class="card">
  <div class="card-body" id="cardb">
    <div class="row">
     <div class="col ">
        <span style="color:black; font-weight:bolder;"><i class="bi bi-person"></i> Casual Informations</span>
        <div><label>Prefix:</label> <?php echo $prefix;  ?></div>
        <div><label>Phone Number:</label><?php echo $pnumber;  ?> </div>
        <div><label>Surname:</label> <?php echo $lname;  ?></div>
        <div><label>Address:</label> <?php echo $Address;  ?></div>
    </div></div>
      <hr>
      <div class="row">
      <div class="col p-0">
          ...
          <div><label>&nbsp; Basic Salary:</label> </div>
          <div><label>&nbsp; Pay Cycle: </label></div>
          <div><label>&nbsp; Means Of Payment: </label></div> 
      </div>
      </div>
      <hr>
