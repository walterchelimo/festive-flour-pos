      ...
      while($row=mysqli_fetch_array($results21)){
          ...
          <td>
                    <div class="dropdown">
                      ...
                      <a class="dropdown-item" href="editcasual.php?id=<?php echo $row['Casualid']?>"><i class="bi bi-pencil-square"></i>edit</a>
                      <a class="dropdown-item" href="viewcasual.php?id=<?php echo $row['Casualid']?>"><i class="bi bi-eye"></i>view</a>
                      <a class="dropdown-item" href="addpay.php?id=<?php echo $row['Casualid']?>"><i class="bi bi-eye"></i>add payments</a>
                      <a class="dropdown-item" href="viewpay.php?id=<?php echo $row['Casualid']?>"><i class="bi bi-eye"></i>view payments</a>
                      </div>
                    </div>
                </td>
            <?php
