        ...
        <div class="container">
          ...
          <form action="" method="POST">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="AttendanceName" value="<?php echo $AttendanceName; ?>" name="AttendanceName">
            </div>
            <div class="form-group">
              <label for="Available">Available Packagers:</label>
              <input type="number" class="form-control" id="Available" value="<?php echo $Available; ?>" name="Available">
            </div>
            <div class="form-group">
              <label for="WagePerPackager">Wage Per Packager</label>
              <input type="number" class="form-control" id="WagePerPackager" value="<?php echo $WagePerPackager; ?>" name="WagePerPackager">
            </div>
            <div class="form-group">
              <label for="Date">Attendance Date:</label>
              <input type="text" class="form-control" id="Date" value="<?php echo $Date; ?>" name="Date" readonly>
            </div>
            <button type="submit" name="update" class="btn btn-primary col-md-3">Update Changes</button>
            <a href="attendance.php" class="btn btn-danger col-md-3">Back</a>
          </form>
        </div>
      </body>
