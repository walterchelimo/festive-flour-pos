...
if (isset($_POST["submit"]) and !empty($_POST["id"])){
    ...
    $sql = "DELETE FROM `casuals` WHERE Casualid=$id";
...
<div class="row m-2">
    <div class="alert alert-danger">
        <form action="deletecasual.php" method="post">
       
            <div class="row" >
                <label class="form-label">Are you sure you want to delete <?php echo $fname?>'s record?</label> <br>
                <input type="hidden" name="id" value="<?php echo $_GET['id']; ?>">
               <input type="submit" name="submit" value="YES" class="btn btn-danger col-md-3">
               <a href="hrm.php" class="btn btn-primary col-md-3" style="height: 40px;">NO</a>
            </div>
