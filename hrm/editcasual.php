...
<div class="container">
  ...
  <form action="" method="POST">
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="FirstName" value="<?php echo $FirstName;?>" name="FirstName" readonly>
    </div>
    <div class="form-group">
      <label for="LastName">Surname:</label>
      <input type="text" class="form-control" id="LastName" value="<?php echo $LastName;?>" name="LastName" readonly>
    </div>
    <div class="form-group">
      <label for="PhoneNumber">PhoneNumber:</label>
      <input type="number" class="form-control" id="PhoneNumber" value="<?php echo $PhoneNumber;?>" name="PhoneNumber" readonly>
    </div>
    <div class="form-group">
      <label for="Address">Address</label>
      <input type="text" class="form-control" id="Address" value="<?php echo $Address;?>" name="Address" readonly>
    </div>
