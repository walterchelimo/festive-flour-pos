  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <form action="addhrm.php" method="post" class="form" style="margin-right: 10px;">
...
<div>
<input type="" name="Salary" placeholder="Salary" required>
</div>
</div>
...
<h2>Human Resource form </h2>
  ...
  <?php 
      include "../connect.php";
      $sql="SELECT * FROM hrm ORDER BY id DESC LIMIT 10 ";
      $results21=mysqli_query($conn, $sql);
      $num_rows21=mysqli_num_rows($results21);
      if($num_rows21>0){ 
            echo " <h2>Most Recent Sales</h2>";
     ...
     while($row=mysqli_fetch_array($results21)){
         ...
         echo "<td>".$row['LastName']."</td>" ;
               ...
               echo " <td>
                    ...
                    <a class='m-2' href='deletehrm.php?id=".$row['ID']."'><span class='bi bi-trash'></span></a>
                    <a class='m-2' href='viewhrm.php?id=".$row['ID']."'><span class='bi bi-pen'></span></a>
                    </td>";
