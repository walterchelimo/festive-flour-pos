    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="col">
                ...
                <h2>Update Customer Orders Details</h2>
                </div>
...
<div class="container">
  <form action="" method="POST">
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="ProductName" value="<?php echo $Pname; ?>" name="ProductName">
    </div>
    <div class="form-group">
      <label for="CustomerName">Customer Id:</label>
      <input type="text" class="form-control" id="CustomerName" value="<?php echo $Cname; ?>"name="CustomerName" readonly>
    </div>
    <div class="form-group">
      <label for="Quantity1">1KG Bale Order</label>
      <input type="number" class="form-control" id="Quantity1" value="<?php echo $Quantity1; ?>" name="Quantity1">
    </div>
    <div class="form-group">
      <label for="Quantity2">2KG Bale Order</label>
      <input type="number" class="form-control" id="Quantity2" value="<?php echo $Quantity2; ?>" name="Quantity2">
    </div>
    <div class="form-group">
      <label for="TotalSell">TotalSell</label>
      <input type="number" class="form-control" id="TotalSell" value="<?php echo $TotalSell; ?>" name="TotalSell">
    </div>
    <div class="form-group">
      <label for="OrderDate">Order Placement Date:</label>
      <input type="date" class="form-control" id="OrderDate" value="<?php echo $OrderDate; ?>" name="OrderDate">
    </div>
   
    <button type="submit" name="update" class="btn btn-primary">Update Changes</button>
    <a href="../customerorders/customerorders.php" class="btn btn-danger col-md-3">Back</a>
  </form>
</div>
            </div></div></div></main>
</body>
