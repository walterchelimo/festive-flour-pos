...
<a class="nav-link collapsed" href="../logout.php">
  ...
  <script src="assets/js/main.js"></script>
    ...
    $id=$_GET['id'];
                ...
                $sql2="UPDATE customerorder SET Due='$TotalDue',PaymentAmount='$Paid' WHERE OrderId='$id'";
                $res=mysqli_query($conn,$sql2);
                if($res){
                    $sql3="INSERT INTO addpayment1 (Paying,Balance,OrderId) VALUES('$Paying','$TotalDue','$id')";
    ...
    <div class="card">
       ...
       <form action="" method="post" id="myform">
            <div class="row">
                ...
                <input type="number" step="any" class="form-control" name="TotalAmount" value="<?php echo $TotalAmount  ?>" readonly onkeyup="calculate(this.value)">
                </div>
                <div class="col-lg-4 col-sm-12">
                <label>Total Due(Ksh)<caps>*</caps></label>
                <input type="number" step="any" class="form-control" name="TotalDue" value="<?php echo $Due  ?>" readonly onkeyup="calculate(this.value)">
                </div>
                 <div class="col-lg-4 col-sm-12">
                <label>Paid(Ksh)<caps>*</caps></label>
                <input type="number" step="any" class="form-control" name="Paid" value="<?php echo $Paid  ?>" readonly onkeyup="calculate(this.value)">
                </div>
                <div class="col-lg-4 col-sm-12">
                ...
                <input type="number" step="any" class="form-control" name="Balance" onkeyup="calculate(this.value)">
                    </div>
            </div>
                            <div>
