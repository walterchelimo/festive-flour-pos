  ...
  <script src="assets/js/main.js"></script>
     ...
     <?php
                  ...
                  if(isset($_POST['submit'])){
                    $ProductName2=$_POST['ProductName'];
                    $CustomerName2=$_POST['CustomerName'];
                    $Quantity1=$_POST['Quantity1'];
                    $Quantity2=$_POST['Quantity2'];

                   $sql101 = "INSERT into customerorder (ProductName,CustomerName,Quantity1,Quantity2) VALUES('$ProductName2','$CustomerName2','$Quantity1','$Quantity2')";
                   $query = mysqli_query($conn, $sql101);
                   if ($query) {
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="col">
                ...
                <div class="col">
            <a href="addcustomerorder.php"><button type="button" class="btn btn-info btn-lg" style="float:right;"><i class="bi bi-plus-circle"></i> New Sales Order</button></a>
            </div>
  </div>
            <div class="row mb-5">
            <div class="col">
...
<?php 
    include "../connect.php";
    $sql="SELECT * FROM customerorder where Status= 0 ORDER BY OrderId DESC";
    ...
    if($num_rows21>0){
        echo "<div class='table-responsive' style='height:500px;'>";
           ...
           echo "<th>Product</th>";
           echo "<th>Quantity(1kg package)</th>";
           echo "<th>Quantity(2kg package)</th>";
           echo "<th>Total Amount</th>";
           echo "<th>Total Deposit</th>";
           echo "<th>Placement Date</th>";
           echo "<th>Status</th>";
           echo "</tr>";
      while($row=mysqli_fetch_array($results21)){
          ...
          echo "<tbody id='myTable'>";
                ...
                <td>
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu">
                        <a class="dropdown-item" href="deletecustomerorders.php?id=<?php echo $row['OrderId']; ?>"><i class="bi bi-trash"></i>Delete</a>
                        <a class="dropdown-item" href="vieworders.php?id=<?php echo $row['OrderId'];?>"><i class="bi bi-eye"></i>View</a>
                        <a class="dropdown-item" href="edit.php?id=<?php echo $row['OrderId'];?>"><i class="bi bi-pencil"></i>Edit</a>
                        <a class="dropdown-item" href="addpayments.php?id=<?php echo $row['OrderId'];?>"><i class="bi bi-cash-coin"></i>add payment</a>
                        <a class="dropdown-item" href="viewpayment.php?id=<?php echo $row['OrderId']?>&custid=<?php echo $row['CustomerName']?>"><i class="bi bi-cash-coin"></i>View Payments</a>
                        <?php
                        if($Status==0){ 
                        ?>
                        <a class="dropdown-item" href="complete.php?id=<?php echo $row['OrderId']?>"><i class="bi bi-check2-square"></i>Complete Sale</a>
                          <?php 
                        }else{;
                        }
                          ?>
            ...
            ?>
               ...
               if($Status==0){
                echo "<td>";
                   echo "<span style='background-color:brown;padding-left:10px;padding-right:10px;padding-top:5px;padding-bottom:5px;border-radius:6px;color:white; font-size:15px;'>Pending</span>";
                   echo "</td>";
               }else{
                echo "<td>";
                   echo "<span style='background-color:green;padding-left:10px;padding-right:10px;padding-top:5px;padding-bottom:5px;border-radius:6px;color:white; font-size:15px;'>Completed</span>";
                   echo "</td>";
               }
                ?>
            </td>
      ...
      echo "No Pending Customer Orders.";
    }?>
            </div>
    </div>
    <script>
