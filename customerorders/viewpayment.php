...
<a class="nav-link collapsed" href="../logout.php">
  ...
  <script src="assets/js/main.js"></script>
    ...
    include "../connect.php";
                $idc=$_GET['custid'];
                $sqls="select * from customers WHERE CustomerId='$idc'";
...
<main id="main" class="main">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                <?php 
        $id=$_GET['id'];
    $sql4="select * from customerorder where OrderId='$id'";
        ...
        if($num>0){
            ...
            while($row=mysqli_fetch_array($resul)){
                    echo "<tr>";
                    echo "<td>".$row['PaymentAmount']." KSH"."</td>";
                    echo "<td>".$row['Due']." KSH"."</td>";
                    echo "</tr>";
    ...
    include '../connect.php';
    $id=$_GET['id'];
                $sql="select * from addpayment1 WHERE OrderId='$id'";
                $results=mysqli_query($conn,$sql);
                $num=mysqli_num_rows($results);
                if($num>0){
                    echo "<table class='table'>";
                    echo "<tr>";
                    echo "<th>Reference No:(Order)</th>";
