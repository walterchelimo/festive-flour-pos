    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <label>Customer Name:</label> <?php
                                                            $sql1="SELECT * FROM customers WHERE CustomerId='$CustomerName'";
            ...
            <div class="col-lg-3 col-sm-10">
                <label>Product Name:</label><?php echo $ProductName;  ?>
            </div>
            </div><hr>
                        <div class="row">
                            <div class="col">
                            <div>
                <label>Phone Number:</label><?php echo $pnumber;  ?>
                                    </div>
                                    <div>
                <label>Location:</label><?php echo $location;  ?>
                                    ...
                                    <hr>
                                <div>
                <label>1KG Order:</label><?php echo $Quantity1;  ?>
                                    </div>
                                    <div>
                <label>2KG Order:</label><?php echo $Quantity2;  ?>
                                    </div>
                                <div>  
                <label>Payterm:</label><?php echo $Payterm;  ?>
                                </div>
                                                                <div>  
                <label>Method Of Payment:</label><?php echo $PaymentMethod;  ?>
                                </div>
                               <div>  
                <label>Sell Date:</label><?php echo $PaymentDate;  ?>
                                </div>
            </div>
            </div>
            <hr>
            ...
            <div class="row">
                <div class="col"><label>Total Amount:</label><?php echo $TotalSell." Ksh";  ?></div>
                <div class="col"><label>Total Paid:</label><?php echo $TotalPaid." Ksh";  ?></div>
                <div class="col"><label>Due:</label><?php echo number_format($Due)." Ksh";?></div>
            </div>
            <hr>
