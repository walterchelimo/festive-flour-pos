              ...
              <div class="d-flex align-items-center">
                ...
                <div class="ps-3">
                  <h6>KES
                      ...
                      <?php
            include "connect.php";
          $query11 = "SELECT SUM(TotalSell) FROM sales WHERE SellDate=SellDate GROUP BY SellDate ORDER BY Sellid DESC LIMIT 1;";
         $rez11 = mysqli_query($conn,$query11);
         $num=mysqli_num_rows($rez11);
         if($num>0){
          while ($row11 = mysqli_fetch_array($rez11)) { 
              $TotalSell11 = $row11['SUM(TotalSell)'];
              echo number_format($TotalSell11);
           }
      }else{
        echo "0";
      }
        ...
        <div class="row">
          ...
          <div class="card">
            <div class="card-body py-5">
              ...
              if($Available2kg>$Alert2kg AND $Available1kg>$Alert1kg AND $Balepackets>$Balepacketa AND $OnekgPackets>$OnekgPacketa
