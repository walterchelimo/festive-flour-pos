...
<a class="nav-link collapsed" href="../logout.php">
  ...
  <script src="assets/js/main.js"></script>
    ...
    include "../connect.php";
                ...
                $sql100="SELECT * FROM products Where ProductName='$ProductName1'";
                $query100=mysqli_query($conn,$sql100);
                if($query100>0){
                  while($rows=mysqli_fetch_array($query100)){
                    $o1kg=$rows['1kgAvailable'];
                    $o2kg=$rows['2kgAvailable'];

                    $new1kg=$o1kg-$Quantity1;
                    $new2kg=$o2kg-$Quantity2;

                    $sql008="UPDATE products SET 1kgAvailable=$new1kg, 2kgAvailable=$new2kg WHERE ProductName='$ProductName1'";
                ...
                $sql="insert into stockout (ProductName,reason,Quantity1,Quantity2) VALUES('$ProductName1','$reason','$Quantity1','$Quantity2')";
...
<main id="main" class="main">
           ...
           <div class="card-body">
               <div class="row">
                   ...
                   <div class="col">
                         <button type="button" class="btn btn-info btn-lg" id="btn1" data-toggle="modal" data-target="#myModal" style="float:right"><i class="bi bi-plus-circle"></i>Add</button>
  <!-- Modal -->
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content p-3">
        <div class="modal-header">
        <h2 class="modal-title">Add Stock Out</h2>
 ...
 <label>Product Name:<caps>*</caps> </label>
    ...
    <div class="col-lg-6 col-sm-12">    
        <label>Purpose:</label>
      <input type="text" class="form-control" name="reason" placeholder="eg, Personal Use" required>
    </div>
          <div class="col-lg-6 col-sm-12">    
        <label>Quantity(1kg package):</label>
      <input type="number" step="any" class="form-control" name="Quantity1" required>
    </div>
                <div class="col-lg-6 col-sm-12">    
        <label>Quantity(2kg package):</label>
      <input type="number" step="any" class="form-control" name="Quantity2" required>
    </div>
        </div>
            ...
            <div class="col-lg-3 col-sm-12">
              <input class="form-control" id="myInput" type="text" placeholder="Search...">
               ...
               <div class="row">
                   <?php
                    include "../connect.php";
                $sql="select * from stockout ORDER BY stockoutid DESC";
                $results=mysqli_query($conn,$sql);
                $num=mysqli_num_rows($results);
                if($num>0){
                    echo "<div class='table-responsive' style='height:500px;'>";
                       echo "<table class='table table-striped table-bordered table-hover'>";
                       echo "<tr class='position-sticky'>";
                       echo "<th>Product</th>";
                       echo "<th> Quantity(1kg)</th>";
                       echo "<th> Quantity(2kg)</th>";
                       echo "<th>Stock Out Date</th>";
                       echo "<th>Action</th>";
                       echo "</tr>";
                ...
                <td>
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu">
                        <a class="dropdown-item" href="deletestock.php?id=<?php echo $row['stockoutid']; ?>"><i class="bi bi-trash"></i>Delete</a>
                        <a class="dropdown-item" href="editstock.php?id=<?php echo $row['stockoutid']; ?>"><i class="bi bi-pencil-square"></i>Edit</a>
                      </div>
                    </div>
                </td>
                   <?php
               ...
               <div class="row">
                   <div class="col">
                       <?php
                       $sq="SELECT ProductName, SUM(Quantity1+Quantity2) FROM stockout GROUP BY ProductName";
                       $query=mysqli_query($conn,$sq);
                       if($query){
                           while($row=mysqli_fetch_array($query)){
                               echo $row[0].":".$row[1]." Bales"."<br>";
                           }
                       }
