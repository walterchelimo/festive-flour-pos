...
if (isset($_POST["submit"]) and !empty($_POST["id"])){
    ...
    $sql = "DELETE FROM `stockout` WHERE stockoutid=$id";
    ...
    if ($result){
        ...
        echo "<a class='btn btn-primary col-md-4' href='stockout.php'>BACK</a>";
        echo "</div>";
    ...
    <div class="alert alert-danger">
        <form action="" method="post">
            ...
            <div class="p-2 text-center">
                ...
                <a href="stockout.php" class="btn btn-primary col-md-3">NO</a>
            </div>
        </form>
