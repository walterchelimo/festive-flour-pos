...
<?php
                    ...
                    $update="UPDATE stockout SET ProductName='$ProductName', Quantity1='$Quantity1',Quantity2='$Quantity2' WHERE stockoutid='$ID'";
...
<a class="nav-link collapsed" href="../logout.php">
  ...
  <script src="assets/js/main.js"></script>
    ...
    include "../connect.php";
                $ID=$_GET['id'];
                $sqlp="select * from stockout WHERE stockoutid=$ID";
...
<div class="row" style="padding-bottom: 10px;">
    ...
    <div class="col-lg-4 col-sm-12">
        ...
        <div>
        <input type="number" min=1 name="Quantity1" class="form-control" value="<?php  echo $Quantity1; ?>">
        </div>
    </div>
    <div class="col-lg-4 col-sm-12">
        <label>Quantity(2kg package)</label>
        <div>
        <input type="number" min=1 name="Quantity2" class="form-control" value="<?php  echo $Quantity2; ?>">
        </div>
    </div>
                     ...
                     <div class="row">
               <input type="submit" class="form-control" name="update" id="save" value="Update">
      </div>
      </form>
          </main>
    </body>
