...
<a class="nav-link collapsed" href="../logout.php">
  ...
  <div class="container">
  <h2>Update Raw Material Details</h2>
  <form action="" method="POST">

    <div class="form-group">
      <label for="MaterialName">Material Name:</label>
      <input type="text" class="form-control" id="MaterialName" value="<?php echo $MaterialName?>" name="MaterialNameMaterialNameMaterialName" readonly>
    </div>
    
    <div class="form-group">
      <label for="Quantity">Quantity</label>
      <input type="text" class="form-control" id="Quantity" value="<?php echo $Quantity?>" name="Quantity" readonly>
    </div>
    <a href="rawmaterial.php" class="btn btn-danger col-md-3">Back</a>
