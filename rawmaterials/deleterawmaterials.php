...
<div class="row m-2">
    <div class="alert alert-danger">
        <form action="deleterawmaterials.php" method="post">
            ...
            <div class="p-2 text-center">
                ...
                <a href="rawmaterial.php" class="btn btn-primary  m-2" style="padding-left:10%; padding-right:10%; font-size: 20px;">NO</a>
            </div>
        </form>
