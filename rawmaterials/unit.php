...
<form action="addunit.php" method="POST">
    ...
    <div class="row">
      <div class="col-lg-4 col-sm-12">
          <label>Name:<caps>*</caps><i class="bi bi-info-circle-fill text-primary"></i></label>
          <input type="text" class="form-control" name="Name" required placeholder="Unit Name">
    </div>

    <div class="col-lg-4 col-sm-12">
          <label>Short Name:<caps>*</caps></label>
          <input type="text" class="form-control" name="ShortName" required placeholder="ShortName">
      </div>       
    </div>
