...
<a class="nav-link collapsed" href="../logout.php">
  ...
  <span>Raw Materials </span> manage Raw Materials
<hr>    
            <div>
          <div class="card">
  <div class="card-body">
  ...
  <?php
            if(strpos($permission,'araw') !== false){
                ?>
...
<div class="row">
      ...
      <div class="modal-content p-3">
        ...
        <form action="addrawmaterials.php" method="POST">
                ...
                <div class="col-lg-4 col-sm-12">
                      ...
                      <input type="text" class="form-control" name="MaterialName" required placeholder="Raw Material Name">
                  </div>     
                  <div class="col-lg-4 col-sm-12">
                  <label>Opening Stock:<caps>*</caps></label>
                      <input type="text" class="form-control" name="Quantity" required placeholder="Quantity">
                  </div>  
                  <div class="col-lg-4 col-sm-12">
                  <label>Alert Quantity:<caps>*</caps><i class="bi-exclamation-triangle text-warning"></i></label>
                      <input type="number" step="any" class="form-control" name="aq" required placeholder="10 sacks">
                  </div>  
                </div>
 ...
 Show  <select name="entries" id="entries">
  ...
  <input class="form-control" id="myInput" type="text" placeholder="Search...">
    ...
    $sql="SELECT * FROM rawmaterials ORDER BY ID ASC LIMIT 10 ";
    ...
    if($num_rows21>0){ 
     ...
     while($row=mysqli_fetch_array($results21)){
               ...
               <td>
               <?php
            if(strpos($permission,'draw') !== false){
                ?>
                   <div class="dropdown">
                     ...
                     <div class="dropdown-menu">
                       <a class="dropdown-item" href="deleterawmaterials.php?id=<?php echo $row['ID']; ?>"><i class="bi bi-trash"></i>Delete</a>
                     </div>
                   </div>
                   <?php
               }
