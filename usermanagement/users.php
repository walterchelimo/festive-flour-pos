...
<span>All Users</span>
            ...
            <?php
               ...
               $word='auser';
               if(strpos($permission,$word) !== false){
                ?>
                <td>
      ...
      echo "<tbody  id='myTable'>";
         ...
         echo "<td>".$row['LastName']." ".$row['LastName']."</td>" ;
               ...
               if(strpos($permission,$word) !== false){
                ?>
                <td>
                <a class='m-2 text-light' href='delete.php?id=<?php echo $row['user_ID']?>'><span class='bi bi-trash p-2 bg-danger' style='font-size:20px; border-radius:4px;' >Delete</span></a>
                
                <?php
               }if(strpos($permission,$word1) !== false){
                ?>
                <a class='m-2' href='view.php?id=<?php echo $row['user_ID']?>'><span class='bi bi-pencil-square bg-primary p-2'  style='font-size:20px; border-radius:4px;'>Edit</span> </a>

                <?php
               }if(strpos($permission,$word2) !== false){
                ?>
                <a class='m-2' href='viewprofile.php?id=<?php echo $row['user_ID']?>'><span class='bi bi-eye bg-info p-2 text-light'  style='font-size:20px; border-radius:4px;'>view </span></a>
                </td>
                <?php
               }
