        ...
        <div class="card">
          <div class="card-body">
            <div class="row">
              ...
              <div class="col">
                <a href="addrole.php"><button type="button" class="btn btn-info btn-lg" style="float:right;"><i class="bi bi-plus-circle"></i>Add</button></a>
              </div>
            </div>
          <div class="row">
          <div class="col">
        ...
        <div class="row">
          ...
          if($num>0){
            while($ro=mysqli_fetch_array($query)){
              ...
              echo "<tr>";
              echo "<td>".$ro['RoleName']."</td>" ;
              ?>
              <td>
              <a class='m-2 text-light' href='deleterole.php?id=<?php echo $ro['ID']?>'><span class='bi bi-trash p-2 bg-danger' style='font-size:20px; border-radius:4px;' >Delete</span></a>
              <a class='m-2' href='editrole.php?id=<?php echo $ro['ID']?>'><span class='bi bi-pencil-square bg-primary p-2'  style='font-size:20px; border-radius:4px;'>Edit</span> </a>
            </td>
            </tbody>
        </div>
            <?php
