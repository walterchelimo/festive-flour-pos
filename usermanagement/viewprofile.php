...
<a class="nav-link collapsed" href="../logout.php">
  ...
  <div class="card-body" id="cardb">
        <div class="row" style="text-align:center;" >
            <span style="border-radius:50%;height:100px;margin-left:auto;margin-right:auto; border:4px solid #525f7f; text-align:center; font-size:50px; width:100px; background-color:gray; color:black;"><?php echo strtoupper(substr($fname, 0, 2))  ?></span>
