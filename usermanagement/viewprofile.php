...
<a class="nav-link collapsed" href="../logout.php">
  ...
  <script src="assets/js/main.js"></script>
    ...
    include "../connect.php";
    $id=$_GET['id'];
    $sql2="SELECT * FROM addusers WHERE user_ID='$id'";
                ...
                if($num>0){
                    while($row1=mysqli_fetch_array($result2)){
                        ...
                        $email=$row1['Email'];
                        $pnumber=$row1['PhoneNumber'];
                        $address=$row1['Address'];
                        $role=$row1['Role'];
                        $accountname=$row1['AccountHolderName'];
                        $accountnumber=$row1['AccountNumber'];
                        $bankname=$row1['BankName'];
                        $bankbranch=$row1['Branch'];
                        $bankvcode=$row1['BankIdentifierCode'];
                        $taxid=$row1['TaxPayerID'];
                        $paycycle=$row1['PayMentCycle'];
                        $meansofpay=$row1['PayComponents'];
  ...
  <div class="card-body" id="cardb">
        <div class="row" style="text-align:center;" >
            <span style="border-radius:50%;padding:2%;height:auto;margin-left:auto;margin-right:auto; border:4px solid #525f7f; text-align:center; font-size:60px; width:auto; background-color:gray; color:black;"><?php echo strtoupper(substr($fname, 0, 2))  ?></span>
      ...
      <div class="row">
          ...
          <div class="col">
             <span style="color:blue;"><?php echo $username  ?></span> 
          </div>
      </div>
      <hr>
            <div class="row">
      ...
      <hr>
          ...
          <div class="col">
             <span style="background-color:green; color:white; border-radius:6px; font-size:16px; padding-left:5px; padding-right:5px;padding-top:2px;padding-bottom:2px;">Active</span> 
          </div>
      </div>
      <hr>
      <div class="row col-12" id="btn1">
      <a href="view.php?id=<?php echo $_GET['id'];  ?>"><input type="button" class="bg-primary col-12" value="EDIT"></a>
      </div>
...
<div class="row">
    <div class="col ">
        <span style="color:black; font-weight:bolder;"><i class="bi bi-person"></i> User Informations</span>
        <div><label>Prefix:</label> <?php echo $prefix;  ?></div>
        <div><label>Phone Number:</label><?php echo $pnumber;  ?> </div>
        <div><label>Username:</label> <?php echo $username;  ?></div>
    </div>
    <div class="col">
    </div>

      </div><hr>
              <span style="color:black; font-weight:bolder;">Bank Details</span>
    <div class="col p-0">
        <div class="col-lg-4 col-sm-12 p-0"><label>Account Name:</label> <?php echo $accountname;  ?></div>
        <div class="col-lg-4 col-sm-12 p-0"><label>Account Number:</label> <?php echo $accountnumber;  ?></div>
        <div class="col-lg-4 col-sm-12 p-0"><label>Bank Name:</label><?php echo $bankname;  ?> </div>
        <div class="col-lg-4 col-sm-12 p-0"><label>Bank Branch:</label> <?php echo $bankbranch;  ?></div>
        <div class="col-lg-4 col-sm-12 p-0"><label>Tax Payer Id:</label> <?php echo $taxid;  ?></div>
        <div class="col-lg-4 col-sm-12 p-0"><label>Bank Identification Code:</label> <?php echo $bankvcode;  ?></div>
    </div><hr>
      <div class="col p-0">
          <div class="col p-0"><label>Address Location:</label>  <?php echo $address;  ?></div>
      </div>
      <hr>
      <div class="col p-0">
          <span style="color:black; font-weight:bolder;">HRM DETAILS:</span>
          <div class="col p-0"><label>Role:</label> <?php echo $role;  ?></div>
          <div class="col p-0"><label>Basic Salary:</label> <?php echo $basicsalary;  ?></div>
          <div class="col p-0"><label>Pay Cycle: </label><?php echo $paycycle;  ?></div>
          <div class="col p-0"><label>Means Of Payment: </label><?php echo $meansofpay;  ?></div> 
      </div>
      <hr>
