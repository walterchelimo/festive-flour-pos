...
$sql = "SELECT FirstName, Role, LogInTime FROM logs ORDER BY LogInTime DESC;";
  ...
  $num_row=mysqli_num_rows($result);?>
    <?php 
        ...
        <table class="table table-striped table-bordered" id="product_table">
          <thead style="width:100%;position:sticky;top:0;background-color:gray;color:white;border-radius:6px;">
            <tr>
