...
<a class="nav-link collapsed" href="../logout.php">
  ...
  <div class="card-body">
    ...
    <div class="col-lg-4 col-sm-12">
        <label>Prefix</label>
      <input type="text" class="form-control" id="prefix" placeholder="Mr/Mrs/Miss" name="prefix">
    </div>
    <div class="col-lg-4 col-sm-12">
    ...
    <div class="col-lg-4 col-sm-12">
      ...
      <input type="text" class="form-control" name="LastName">
                ...
                <div class="col-lg-4 col-sm-12">
        <label>Email</label>
      <input type="email" class="form-control" placeholder="Doe@gmail.com" name="Email">
    </div>
    <div class="col-lg-4 col-sm-12">
        <label>Phone Number</label>
      <input type="PhoneNumber" class="form-control" placeholder="0711111111" name="PhoneNumber">
    </div>
                <div class="col-lg-4 col-sm-12">
        <label>Address</label>
 ...
 <span>Role And Permissions</span>
  <div class="card-body">
    ...
    <div class="col-lg-4 col-sm-12">
      ...
      <input type="text" class="form-control" id="prefix" name="username">
    </div>
    <div class="col-lg-4 col-sm-12">
 ...
 <span>Bank Details:</span>
  <div class="card-body">
    ...
    <div class="col-lg-4 col-sm-12">
      ...
      <input type="text" class="form-control" placeholder="Account Holder's Name" id="AccountHolderName" name="AccountHolderName">
    </div>
    <div class="col-lg-4 col-sm-12">
    ...
    <div class="col-lg-4 col-sm-12">
      ...
      <input type="text" class="form-control" name="BankIdentifierCode" placeholder="Bank Identifier Code">
    </div>
    ...
    <div class="col-lg-4 col-sm-12">
      ...
      <input type="text" class="form-control" name="TaxPayerID" placeholder="Tax Payer ID">
    </div>
    ...
    <label>Basic Salary <i class="bi bi-info-circle-fill text-primary" ></i></label>
        ...
        <input type="number" step="any" name="BasicSalary" class="form-control" placeholder="Basic Salary">
              </div>
      <div class="input-group-prepend m-0" class="form-control" >
        ...
        <input type="text" class="form-control" name="PayComponents" placeholder="Pay Components">      
        </div>
          
                  <div class="col-lg-4 col-sm-12">
        <label>Added On: </label>
        <input type="date" id="date" class="form-control" name="Date" placeholder="Added On">      
        </div>
