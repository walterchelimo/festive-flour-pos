...
if (isset($_POST["submit"]) and !empty($_POST["id"])){
    ...
    $sql = "DELETE FROM `addusers` WHERE user_ID=$id";
    ...
    if ($result){
        ...
        echo "<a class='btn btn-primary col-md-4' href='users.php'>BACK</a>";
        echo "</div>";
    ...
    <div class="alert alert-danger">
        <form action="delete.php" method="post">
            ...
            <div class="p-2 text-center">
                ...
                <a href="users.php" class="btn btn-primary col-md-3">NO</a>
            </div>
        </form>
