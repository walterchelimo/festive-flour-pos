...
<main id="main" class="main">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                <?php 
        $id=$_GET['ID'];
    $sql4="select * from packetpurchase where PPurchaseId='$id'";
        ...
        if($num>0){
            ...
            while($row=mysqli_fetch_array($resul)){
                    echo "<tr>";
                    echo "<td>".$row['Payment']." KSH"."</td>";
                    echo "<td>".$row['TotalDue']." KSH"."</td>";
                    echo "</tr>";
    ...
    include 'connect.php';
    $id=$_GET['ID'];
                $sql="select * from addpacketpurchase WHERE PPurchaseId='$id'";
                ...
                if($num>0){
                    ...
                    echo "<td>".$row['addpacketpurchaseID']."</td>";
