...
include "logics.php";
                    ...
                    if(isset($_POST['update'])){
                        $BalePackets=$_POST['BalePackets'];
                        $_1kgPackets=$_POST['1kgPackets'];
                        $_2kgPackets=$_POST['2kgPackets'];
                    
                    $update="UPDATE packets SET BalePackets='$BalePackets', 1kgPackets='$_1kgPackets', 2kgPackets='$_2kgPackets' WHERE packetid=$id";
...
<a class="nav-link collapsed" href="logout.php">
  ...
  <script src="assets/js/main.js"></script>
    ...
    <?php
                 include "connect.php";
                $id=$_GET['id'];
                $sqlp="select * from packets WHERE packetid=$id";
...
<form action="" method="POST" id="myform">
  ...
  <div class="card-body">
    ...
    <div class="col-lg-4 col-sm-12">
        <label>Available Bale Packets:</label>
        <div>
        <input type="number" min=0 name="BalePackets" value="<?php  echo $BalePackets; ?>" class="form-control" >
        </div>
    </div>
    <div class="col-lg-4 col-sm-12">
        <label>Available 1KG Packets</label>
        <div>
        <input type="number" min=0 name="1kgPackets" class="form-control" value="<?php  echo $_1kgPackets; ?>">
        </div>
    </div>
    <div class="col-lg-4 col-sm-12">
        <label>Available 2KG Packets</label>
        <div>
        <input type="number" min=0 name="2kgPackets" class="form-control" value="<?php  echo $_2kgPackets?>" >
        </div>
    </div></div>
    
    <div class="row">
               <input type="submit" class="form-control" name="update" id="save" value="Update Packets">
      </div>
</div>        
      </form>
          </main>
