...
if($res){
    while($row=mysqli_fetch_array($results07)){
      $_strict1=$row['1kgAvailable'];
      $_strict2=$row['2kgAvailable'];
      if ($Quantity1>$_strict1){
    echo("<script LANGUAGE='JavaScript'>
    window.alert('No available 1KG Bales. Please Add to Orders');
    window.location.href='../customerorders/addcustomerorder.php';
    </script>
    ");
      }
      elseif($Quantity2>$_strict2){
    echo("<script LANGUAGE='JavaScript'>
    window.alert('No available 2KG Bales. Please Add to Orders');
    window.location.href='../customerorders/addcustomerorder.php';
    </script>
    ");
      }
...
<div class="card">
 ...
 <label>Customer:<caps>*</caps> </label>
    ...
    <label for="sellingprice">Selling Price:</label>
      <input type="number" readonly class="form-control" id="sellingprice" name="sellingprice"  onkeyup="calculate(this.value)" value="<?php echo $tota; ?>">
    </div>
    <div class="col-lg-4 col-sm-12">
...
<div class="card">
  ...
  <div class="row">
    ...
    <label for="TotalSell">Total Sales Amount:</label>
      <input type="number" step="any" class="form-control" id="TotalSell" name="TotalSell" readonly>
    </div>
</div>
</div>
</div>
...
<div class="form-group">
  ...
  <option value="Monthly">Monthly</option>
    ...
    <label for="Due">Due:</label>
      <input type="number" step="any" class="form-control" id="Due" readonly name="Due">
    </div> 
    </div>
</div>
</div>
...
<div class="col-md-1"><input class="btn btn-primary" type="submit" value="Sell" name="submit"></div>
  </div></div><br>
    <hr>
    </div>
    </div>
