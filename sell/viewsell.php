...
<main id="main" class="main">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="col-lg-3 col-sm-12">
                <label>Product Name:</label><?php echo $ProductName;  ?>
                        ...
                        <div class="row">
                            <div class="col">
                                <div>
                <label>Quantity:</label><?php echo $Quantity;  ?>
                                    </div>
                                <div>  
            ...
            <div class="col">
                <label>Discount:</label><?php echo $DiscountAmount ?>
            </div>
            </div>
            <hr>
            
            <div class="row">
                <div class="col"><label>Total Amount:</label><?php echo $TotalSell;  ?></div>
                <div class="col"><label>Total Paid:</label><?php echo $TotalPaid;  ?></div>
                <div class="col"><label>Due:</label><?php echo $Due;  ?></div>
            </div>
            <hr>
