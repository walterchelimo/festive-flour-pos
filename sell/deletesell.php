...
if (isset($_POST["submit"]) and !empty($_POST["id"])){
    ...
    $sql = "DELETE FROM `sales` WHERE Sellid=$id";

    $result = mysqli_query($conn,$sql);

    if ($result){
        $username=$_SESSION['username'];
        $insert	= "INSERT INTO logs (FirstName,Role) VALUES('$username','deleted sell id $id')";
        ...
        echo "<a class='btn btn-primary col-md-4' href='sell.php'>BACK</a>";
        echo "</div>";
    ...
    <div class="alert alert-danger">
        <form action="" method="post">
            ...
            <div class="p-2 text-center">
                ...
                <a href="sell.php" class="btn btn-primary col-md-3">NO</a>
            </div>
        </form>
