    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="col">
                ...
                <?php
                if(strpos($permission,'asal')!== false){
                ?>
            <div class="col">
            <a href="makesale.php"><button type="button" class="btn btn-info btn-lg" style="float:right;"><i class="bi bi-plus-circle"></i>Sell Product</button></a>
            </div>
            <?php
            }
            ?>
...
<?php 
    include "../connect.php";
    $sql="SELECT * FROM sales ORDER BY Sellid DESC";
               ...
               ?>
                <td>
                    <div class="dropdown">
                      ...
                      <?php
                        if(strpos($permission,'dsal')!== false){
                        ?>
                        <a class="dropdown-item" href="deletesell.php?id=<?php echo $row['Sellid']; ?>"><i class="bi bi-trash"></i>Delete</a>
                        <?php
                        }
                        ?>
                        <?php
                        if(strpos($permission,'vsal')!== false){
                        ?>
                        <a class="dropdown-item" href="viewsell.php?id=<?php echo $row['Sellid']; ?>"><i class="bi bi-eye"></i>view</a>
                        <?php
                        }
                        ?>
                        <?php
                        if($row['Due']>0){
                          ?>                        
                        <a class="dropdown-item" href="addpaymentsell.php?id=<?php echo $row['Sellid']; ?>"><i class="bi bi-cash-coin"></i>add payment</a>
                        <?php
                        }
                        ?>
                        <a class="dropdown-item" href="viewpayment.php?id=<?php echo $row['Sellid']?>&custid=<?php echo $row['CustomerName']?>"><i class="bi bi-cash-coin"></i>View Payments</a>
                      </div>
                    </div>
                </td>
    <?php
