...
<?php
                    ...
                    if(isset($_POST['update'])){
                        ...
                        $sql="INSERT INTO addpurchasepayments (ID,Paying) VALUES('$ID','$Paying')";
                        $results=mysqli_query($conn,$sql);
                        if($results){
                          echo "<script>alert('Paid Successfully Successfully')</script>";
                          $update="UPDATE purchases SET AmountPaid='$NewAmountPaid', AmountDue='$NewAmountDue' WHERE ID='$ID'";
...
<a class="nav-link collapsed" href="../logout.php">
  ...
  <script src="assets/js/main.js"></script>
    ...
    include "../connect.php";
                $ID=$_GET['ID'];
                $sqlp="select * from purchases WHERE ID=$ID";
...
<div class="row" style="padding-bottom: 10px;">
    ...
    <div class="col-lg-4 col-sm-12">
        ...
        <div>
        <input type="number"  min=1 name="PaymentAmount" class="form-control" value="<?php  echo $TotalLabourCost; ?>" onkeyup="calculate(this.value)" required>
        </div>
    </div>
    ...
    <div class="col-lg-4 col-sm-12">
        ...
        <div>
        <input type="number"  min=1 name="NewAmountPaid" class="form-control"  >
        </div>
    </div>
