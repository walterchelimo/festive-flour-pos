...
<a class="nav-link collapsed" href="../logout.php">
  ...
  <main id="main" class="main">
     ...
     <span>Purchases </span> manage purchases
...
<span>All Purchases</span>
              ...
              ?>
            <div class="col">
            <a href="addpurchases.php"><button type="button" class="btn btn-info btn-lg" style="float:right;"><i class="bi bi-plus-circle"></i>Add</button></a>
            </div>
            <?php
            }
            ?>
 ...
 Show  <select name="entries" id="entries">
  ...
  <input class="form-control" id="myInput" type="text" placeholder="Search...">
      ...
      <div class="row">
          <?php 
    include "../connect.php";
    $sql="SELECT * FROM purchases ORDER BY ID DESC LIMIT 10 ";
      ...
      $due=$row['AmountDue'];
         ...
         <td>
                   <div class="dropdown">
                     ...
                     <?php
                      if(strpos($permission,'dpur')!== false){
                      ?>
                       <a class="dropdown-item" href="deletepurchase.php?ID=<?php echo $row['ID']?>"><i class="bi bi-trash"></i>Delete</a>
                       <?php
                        }
                        ?>

                     <?php
                      if(strpos($permission,'vpur')!== false){
                      ?>
                       <a class="dropdown-item" href="viewproduct.php?ID=<?php echo $row['ID']?>"><i class="bi bi-eye"></i>view</a>
                       <?php
                        }
                        ?>
                     <?php
                      if(strpos($permission,'Epur')!== false){
                      ?>                                               
                       <a class="dropdown-item" href="editpurchases.php?ID=<?php echo $row['ID']?>"><i class="bi bi-pencil-square"></i>Edit</a>
                       <?php
                        }
                        ?>
                        ...
                        if($due>0){
                          ?>
                          <a class="dropdown-item" href="updatepayment.php?ID=<?php echo $row['ID']?>"><i class="bi bi-cash-coin"></i>add payment</a>
                       <?php
                        }

                        ?>
                     <a class="dropdown-item" href="viewpayment.php?id=<?php echo $row['ID']?>&supplierid=<?php echo $row['Supplier']?>"><i class="bi bi-cash-coin"></i>View Payments</a>
                     </div>
                   </div>
               </td>
               <?php
