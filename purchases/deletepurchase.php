    ...
    <div class="alert alert-danger">
        <form action="" method="post">
            <div class="p-2 text-center">
                <label class="form-label" style="font-size: 20px;"> Are you sure you want to delete this record?</label> <br>
                <input type="hidden" name="ID" value="<?php echo $_GET['ID']; ?>">

            </div>

            <div class="p-2 text-center">
                <input type="submit" name="submit" value="YES" class="btn btn-danger  m-2" style="padding-left:10%; padding-right:10%; font-size: 20px;">
                <a href="products.php" class="btn btn-primary  m-2" style="padding-left:10%; padding-right:10%; font-size: 20px;">NO</a>
            </div>
        </form>
