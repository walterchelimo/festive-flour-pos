    ...
    <main id="main" class="main">
      ...
      if ($num > 0) {
        while ($row = mysqli_fetch_array($res)) {
          ...
          $QualityPercentage = $row['QualityPercentage'];
          ...
          $OffloadingCost = $row['OffloadingCost'];
          $OtherCosts = $row['OtherCosts'];
          $TotalCosts = $row['TotalPrice'];
          $AmountToBePaid = $row['AmountPaid'];
        }
      }
      ...
      <div class="card">
        <div class="card-body">
          <div class="row">
            <div class="col">
              <div> <label>Supplier's Name: </label><?php echo $Supplier; ?></div>
              </label>
            </div>
            <div class="col">
            <div>  <label>Purchase Id: </label><?php echo $PurchaseId; ?></div>
            </div>
          </div>
          <hr>
          <div class="row">
            <div class="col">
              <div><label>Location:</label><?php echo $Location ?></div>
              <div> <label>Purchase Date:</label><?php echo $PurchaseDate ?></div>
              <div><label>Quantity:</label><?php echo $Quantity; ?></div>
              <div><label>UnitCost:</label><?php echo $UnitCost ?></div>
              <div><label>TotalPrice:</label><?php echo $TotalPrice ?></div>
            </div>
            <div class="col">
            <div><label>Product Name:</label><?php echo $ProductName ?></div>
            <div><label>Quality Percentage:</label><?php echo $QualityPercentage ?></div>
            <div><label>Expected Bales:</label><?php echo $ExpectedBales ?></div>
            <div><label>Amount Paid:</label><?php echo $AmountPaid ?></div>
            <div><label>Amount Due:</label><?php echo $AmountDue ?></div>
            ...
            <div class="row">
              <div class="col">
              <div><label>Payment Date:</label><?php echo $PaidOn?></div>
              <div><label>Payment Method:</label><?php echo $PaymentMethod ?></div>
              <div><label>Payment Account:</label><?php echo $PaymentAccount ?></div>
              </div>
              <div class="col">
              <div><label>Product Note:</label><?php echo $PaymentNote ?></div>
              <div><label>Offloading Cost:</label><?php echo $OffloadingCost ?></div>
              </div>
            </div>
            <hr>
            <div class="row">
              <div class="col">
                <div><label>Other Costs:</label><?php echo $OtherCosts ?></div>
              </div>
              <div class="col">
                <div><label>Total Costs:</label><?php echo $TotalCosts ?></div>
              </div>
              <div class="col">
                <div><label>Total Amount Paid:</label><?php echo $AmountToBePaid ?></div>
              </div>
            </div>
          </div>
        </div>
