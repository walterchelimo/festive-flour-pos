...
<div class="container">
  ...
  <label>Raw Material:<caps>*</caps></label>
        <select name="ProductName" id="category" class="form-control">
             <?php
             include "../connect.php";
              $sql = mysqli_query($conn,"SELECT * FROM rawmaterials");                                                                                   
...
<div class="col-lg-4 col-sm-12">    
        ...
        <input type="number" class="form-control" name="quantity"  onkeyup="calculate11(this.value)" min=1 placeholder="Number of Sacks" required>
      </div>
  <div class="col-lg-4 col-sm-12">    
          <label>Weight:<caps>*</caps></label>
        <input type="number" class="form-control" name="qty" onkeyup="calculate11(this.value)" min=1 placeholder="Weight In KGs" readonly>
      </div>

      <div class="col-lg-4 col-sm-12">    
          <label>Unit Cost[per sack]:<caps>*</caps></label>
        <input type="number" class="form-control" name="Cost" onkeyup="calculate11(this.value)" placeholder="Unit Cost" required>
      </div>
      ...
      <div class="col-lg-4 col-sm-12">    
       ...
       <div class="col-lg-4 col-sm-12">    
        ...
        <input type="number" class="form-control" name="QualityPercentage" min=1 onkeyup="calculate11(this.value)" placeholder="QualityPercentage" required>
      </div>
            <div class="col-lg-4 col-sm-12">    
...
<div class="card mt-7">
  ...
  <div class="row">
    <div class="col-lg-4 col-sm-12">
      ...
      <input type="number" class="form-control" name="OffloadingCost" value="20" onkeyup="calculate11(this.value)" min=1 placeholder="Offloading Cost">
    </div>
    <div class="col-lg-4 col-sm-12">
      <label>Other Cost:</label>
      <input type="number" class="form-control" name="OtherCosts" onkeyup="calculate11(this.value)" min=1 placeholder="Other Costs">
    </div>
    <div class="col-lg-4 col-sm-12">
      <label>Total Incurred Costs:</label>
      <input type="number" class="form-control" name="Costs"  placeholder="Amount To Be Paid"  readonly >
    </div>
  </div>
  <div class="row">
  <div class="col-lg-4 col-sm-12"></div><div class="col-lg-4 col-sm-12"></div>
  <div class="col-lg-4 col-sm-12">
  <label>Amount to be Paid</label>
      <input type="number" class="form-control" name="AmountToBePaid"  onkeyup="calculate11(this.value)" readonly >
  </div>
  </div>
</div>
<div class="card mt-7" >
...
<div class="row mt-4">
<div class="col-lg-4 col-sm-12">    
          <label>Paying Amount:<caps>*</caps></label>
        <input type="number" class="form-control" name="AmountPaid"  min=0  onkeyup="calculate11(this.value)" placeholder="Total Amount Paid">
      </div>
      <div class="col-lg-4 col-sm-12"></div>
<div class="col-lg-4 col-sm-12">
<label>Total Due:<caps>*</caps></label>
        <input type="number" class="form-control" name="Due"  min=1  onkeyup="calculate11(this.value)" required readonly>
      </div>
...
<div class="form-group">
  ...
  <textarea class="form-control" name="details" id="details" rows="5" placeholder="Enter Payment Details here..." value="" style="display:none"></textarea>
</div>
</div> 

</div>
<div class="d-flex justify-content-center">
        <button type="submit" name="submit" class="btn btn-default" style="background-color: #3c8dbc;color:white;font-size:20px;padding-left:3%;padding-right:3%;">Add</button>
        </div>
</div>
      </div>    
</script>
 ...
 var text3 = parseInt(document.forms["myform"]["OffloadingCost"].value);   
 }   
 if(isNaN(document.forms["myform"]["OtherCosts"].value) || document.forms["myform"]["OtherCosts"].value=="") {   
 var text4 = 0;   
 } else {   
 var text4 = parseFloat(document.forms["myform"]["OtherCosts"].value);   
 }  
 if(isNaN(document.forms["myform"]["quantity"].value) || document.forms["myform"]["quantity"].value=="") {   
 var text5 = 0;   
 } else {   
 var text5 = parseInt(document.forms["myform"]["quantity"].value);   
 }   
 if(isNaN(document.forms["myform"]["Cost"].value) || document.forms["myform"]["Cost"].value=="") {   
 var text6 = 0;   
 } else {   
 var text6 = parseFloat(document.forms["myform"]["Cost"].value);   
 } 
 if(isNaN(document.forms["myform"]["AmountPaid"].value) || document.forms["myform"]["AmountPaid"].value=="") {   
 var text7 = 0;   
 } else {   
 var text7 = parseFloat(document.forms["myform"]["AmountPaid"].value);   
 } 
 if(isNaN(document.forms["myform"]["QualityPercentage"].value) || document.forms["myform"]["QualityPercentage"].value=="") {   
 var text8 = 0;   
 } else {   
 var text8 = parseFloat(document.forms["myform"]["QualityPercentage"].value);   
 } 
 if(isNaN(document.forms["myform"]["qty"].value) || document.forms["myform"]["qty"].value=="") {   
 var text9 = 0;   
 } else {   
 var text9 = parseFloat(document.forms["myform"]["qty"].value);   
 } 
 document.forms["myform"]["qty"].value = (text5*90);  
 document.forms["myform"]["textbox5"].value = (text5*text6);  
 document.forms["myform"]["Costs"].value = ((text3*text5)+text4);
 document.forms["myform"]["AmountToBePaid"].value = (text5*text6)-((text3*text5)+text4);  
 document.forms["myform"]["Due"].value = ((text5*text6)-((text3*text5)+text4)-text7);  
 document.forms["myform"]["textbox6"].value =  (((text8/100)*text9)/24);   
 } 
</script>
<script>
